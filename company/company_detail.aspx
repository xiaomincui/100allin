...
<asp:Literal id="Literal1" runat="server"><title>公司商铺-环球运费网</title></asp:Literal>
...
<%--						<li>
						...
						<li>
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
                              <td width="26%">营业执照：</td>
                              <td width="24%"><span class="yt"><asp:Literal ID="ltr_z_yingyezhizhao" runat="server"></asp:Literal></span></td>
                              <td width="26%">空运铜牌：</td>
                              <td width="24%"><span class="yt"><asp:Literal ID="ltr_z_kongyuntongpai" runat="server"></asp:Literal></span></td>                              
							</tr>
						  </table>
						</li>	
						<li>
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
                              <td width="26%">身份证：</td>
                              <td width="24%"><span class="yt"><asp:Literal ID="ltr_z_shenfenzheng" runat="server"></asp:Literal></span></td>
                              <td width="26%">NVOCC：</td>
                              <td width="24%"><span class="yt"><asp:Literal ID="ltr_z_nvocc" runat="server"></asp:Literal></span></td>                              
							</tr>
						  </table>
						</li>											
					</ul>
...
<%--					   <div class="contact">
                           ...
                           <tr>
                             ...
                             <td><table width="420" border="0" align="center" cellpadding="0" cellspacing="1">
                               <tr>
                                 ...
                                 <td width="194">营业执照：</td>
                                 <td width="194">空运铜牌：</td>
                               </tr>
                               <tr>
                                 <td height="28">&nbsp;</td>
                                 <td>&nbsp;&nbsp;身份证：</td>
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="menu0box">
					<UL id=menu0>
					  <LI class=hover onclick="window.location.href =('/company/<%=GetQueryString("cid")%>/fcl')" style="display:<%=IIf(havefcl = "0","none","") %>;"><A style="color:#05233B;" href="/company/<%=GetQueryString("cid")%>/fcl/">TA的最新整箱运价</A></LI>

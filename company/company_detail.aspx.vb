...
Partial Class company_company_detail
    ...
    Sub LoadDetail()
        ...
        Dim havefcl_int As Integer = ds.Tables("user").Rows(0)(0)
        Dim havelcl_int As Integer = ds.Tables("user").Rows(1)(0)
        Dim haveair_int As Integer = ds.Tables("user").Rows(2)(0)

        Dim have_int As Integer = 0
        ...
        Label4.Text = "<span>" & ds.Tables("user").Rows(0)("realname").ToString & "</span>"
        ...
        ltrYz.Text = Star1(ds.Tables("user").Rows(0)("star_allin").ToString)
        If ds.Tables("user").Rows(0)("z_yingyezhizhao").ToString Then
            ltr_z_yingyezhizhao.Text = "<img src='/images/shops/t_1.gif'>"
        End If

        If ds.Tables("user").Rows(0)("z_shenfenzheng").ToString Then
            ltr_z_shenfenzheng.Text = "<img src='/images/shops/t_3.gif'>"
        End If

        If ds.Tables("user").Rows(0)("z_nvocc").ToString Then
            ltr_z_nvocc.Text = "<img src='/images/shops/t_2.gif'>"
        End If

        If ds.Tables("user").Rows(0)("z_kongyuntongpai").ToString Then
        ...
        If ds.Tables("user").Rows(0)("star_adv_show_contact").ToString() <> "0" Then
            Panel8.Visible = True
            Panel7.Visible = False
        End If

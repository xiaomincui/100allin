<%@ Page Language="C#" AutoEventWireup="true" CodeFile="5.aspx.cs" Inherits="pm_p_5" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link href="/css3/products.css" rel="stylesheet" type="text/css" /> 
<title>精准营销个人版-赠送图文广告-环球运费网</title>
<style type="text/css">
<!--
.STYLE1 {color: #870C05}
.STYLE2 {color: #02318D}
...
<div class="container" style="overflow:hidden;"><!--主体开始-->
<div class="container_detail">
<div style="border:1px solid #DDDDDD; margin:10px 0px; overflow:hidden;"><img src="images/p_5.jpg" border="0" /></div>
</div>

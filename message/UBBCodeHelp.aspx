<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UBBCodeHelp.aspx.cs" Inherits="message_UBBCodeHelp" validateRequest="false" %>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td background="../member/images/box_2.gif" style="height: 31px" width="780">
                                        <div class="smallBoxTitle">如何发布图片</div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
										<div style="font-size:14px; line-height:25px; padding-top:10px;">
											<table>
												<tr>
													<td width="405" valign="top">在傲赢网论坛帖子内发布图片非常简单，首先需要在网上任意找到一张图片。我们用右面这张图片举个例子，接着您只要按照以下操作即可完成贴图。 </td>
													<td width="360" valign="top"><img src="images/course01.gif" width="360" height="270" /></td>
												</tr>
												<tr>
												  <td valign="top">&nbsp;</td>
												  <td valign="top">&nbsp;</td>
												...
												<tr>
												  <td valign="top"><b>第一步：</b><br />
												    将鼠标移动到图片上，点击鼠标右键，选择“属性”。<br /></td>
												  <td valign="top"><img src="images/course02.gif" width="360" height="269" /></td>
												</tr>
												<tr>
												  <td valign="top">&nbsp;</td>
												  <td valign="top">&nbsp;</td>
												...
												<tr>
												  <td valign="top"><strong>第二步：</strong><br />
											      这时会出现一个对话框，在对话框“地址（URL）”一项旁边，有一段很长的地址。将这段地址“复制”下来。</td>
												  <td valign="top"><img src="images/course03.gif" width="359" height="250" /></td>
												</tr>
												<tr>
												  <td valign="top">&nbsp;</td>
												  <td valign="top">&nbsp;</td>
												...
												<tr>
												  <td valign="top"><strong>第三步：</strong><br />
然后将刚刚“复制”的这段（URL）地址前面加上[img]，后面加上[/img]，格式如下：<br />
[img]<span style="color: #ff0000">您要发布的图片的地址</span>[/img] <br />
将这串代码“粘贴”在发帖或者回帖框内。贴图成功！</td>
												  <td valign="top"><img src="images/course04.gif" width="359" height="138" /></td>
											  </tr>                               
										  </table>
										</div> 
                                  </td>

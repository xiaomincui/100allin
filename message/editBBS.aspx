<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editBBS.aspx.cs" Inherits="message_editBBS" validateRequest="false" %>
                        ...
                        <div>
                                    ...
                                    <td background="../member/images/box_2.gif" style="height: 31px" width="780">
                                        ...
                                        <a href="BBSList.aspx"><asp:Label ID="Label11" runat="server" Text="论坛首页"></asp:Label></a>
                                         > &nbsp;<asp:HyperLink ID="HyperLink1" runat="server">HyperLink</asp:HyperLink>
                                            ...
                                            <asp:Label ID="Label1" runat="server" Text="编辑帖子"></asp:Label>&nbsp;
                            ...
                            <table>
                                <tr>
                                    <td style="width: 65px; text-align: center">
                                        标题</td>
                                    <td>
                                        <asp:TextBox ID="TextBox2" runat="server" Width="664px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="width: 65px; text-align: center">
                                        正文</td>
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" Height="324px" TextMode="MultiLine" Width="664px"></asp:TextBox></td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left"><asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/message/UBBCodeHelp.aspx"
                                            Target="_blank">如何发图片</asp:HyperLink></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td><asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="发表帖子" Font-Size="14px" Width="90px" Height="30px"/>                                    
                                      <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="返回帖子" Font-Size="14px" Width="90px" Height="30px"/></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="baf.aspx.cs" Inherits="intro_baf" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head>
<title>2009年最新BAF/CAF-该页面已转移-环球运费网</title>
<meta name="keywords" content="BAF CAF 附加费" />
    ...
    <div class="main_container"><!--页面主体开始-->	
		...
		<div class="menu"><!--导航开始-->
		  <h1><userwelcome:userwelcome ID="userwelcome1" runat="server" />
		    您现在的位置:<a href="/" target="_blank">首页</a> > 2009年最新BAF/CAF</h1>

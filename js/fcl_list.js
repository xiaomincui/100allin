...
{			
		...
		　　document.getElementById("mm").style.visibility="visible";
			...
			str += "<tr><td height=\"28\" colspan=\"7\" align=\"left\"><span style=\"color:#000000;\">" + document.getElementById(id).innerHTML + "</strong></span></td>";
			...
			str += "<td align=\"left\"><span style=\"font:13px '宋体'; color:#000000;\"><strong>20'</strong></span></td>";
			str += "<td align=\"left\"><span style=\"font:13px '宋体'; color:#000000;\"><strong>40'</strong></span></td>";
			str += "<td align=\"left\"><span style=\"font:13px '宋体'; color:#000000;\"><strong>40H'</strong></span></td>";
			str += "<td align=\"left\"><span style=\"font:13px '宋体'; color:#000000;\"><strong>45H'</strong></span></td>";			
			...
			for(var j=0;j<pp.length;j=j+1)
			{
				...
				for(var k=0;k<price.length;k=k+1)
				{
					...
					if (k == 7)
					{
						str += "<td align=\"center\"  class=\"dc\"><a href=\"/search/fcl_order.aspx?filter=new&" + price[k] + "\" target=\"_blank\"></a></td>"
					}
				}

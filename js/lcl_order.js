...
if (document.getElementById("txtGrossWeight").value > document.getElementById("txtMeasurement").value)
{
	...
	pricegp = document.getElementById("txtGrossWeight").value * document.getElementById("fgp").innerHTML;
}
else
{
	gp = document.getElementById("txtMeasurement").value;
	pricegp = document.getElementById("txtMeasurement").value * document.getElementById("fgpv").innerHTML;
}


document.getElementById("txtgp").value = gp;

var totaldingcangn = gp*10;

totaldingcang = gp + "*10";

totaldingcang = totaldingcang + " = " + totaldingcangn;

document.getElementById("spangp").innerHTML = gp;
...
if ((document.getElementById("txtGrossWeight").value * 1) > (document.getElementById("txtMeasurement").value * 1))
{
	gp = document.getElementById("txtGrossWeight").value;
	pricegp = document.getElementById("txtGrossWeight").value * document.getElementById("fgp").innerHTML;
}

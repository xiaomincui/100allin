...
function PasswordStrength(showed){	
	...
	this.styles[0] = {backgroundColor:"#EBEBEB",borderTop:"solid 1px #FFFFFF",borderRight:"solid 1px #FFFFFF",borderBottom:"solid 1px #FFFFFF"};	
	this.styles[1] = {backgroundColor:"#FF4545",borderTop:"solid 1px #FFFFFF",borderRight:"solid 1px #FFFFFF",borderBottom:"solid 1px #FFFFFF"};
	this.styles[2] = {backgroundColor:"#FFD35E",borderTop:"solid 1px #FFFFFF",borderRight:"solid 1px #FFFFFF",borderBottom:"solid 1px #FFFFFF"};
	this.styles[3] = {backgroundColor:"#95EB81",borderTop:"solid 1px #FFFFFF",borderRight:"solid 1px #FFFFFF",borderBottom:"solid 1px #FFFFFF"};

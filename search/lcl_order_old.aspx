<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lcl_order_old.aspx.cs" Inherits="search_lcl_order" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 <table width="100%" class="order_table_a" style="BORDER-TOP-WIDTH: 0px" border="0" cellspacing="0" cellpadding="0">
  <tbody>
   ...
   <tr>
    ...
    <th align="left" style="HEIGHT: 36px"><input size="14" class="normalInput" id="txtjieguanri" runat="server" readonly="readonly"/> <img width="28" height="22" align="middle" style="CURSOR: pointer" src="/images/fcl/calendar.gif" alt="" id="imgjieguanri"/></th>
    <th style="HEIGHT: 36px"><strong>　</strong><strong>运价详情：</strong> </th>
    <th align="left" style="HEIGHT: 36px">&nbsp;<asp:Literal ID="ltrFreightDetail" runat="server"></asp:Literal>  </th>
   </tr>
...
//]]>
   ...
   <tr>
    ...
    <input id="txt20gp" value="0" class="normalInput" size="12" runat="server" style="ime-mode:Disabled" onkeypress="return event.keyCode>=48&&event.keyCode<=57" onpaste="return !clipboardData.getData('text').match(/\D/)"/> CBM
...
船公司：<span id="spancarrier"></span><br/>

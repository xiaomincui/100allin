...
Partial Class search_fcl_detail
    ...
    Sub LoadDetail()
        ...
        Else
            seotitle = seocr1 & Label1.Text & "-" & Literal5.Text & "到" & LtrDestport.Text & "-" & Literal6.Text & "-" & seotitle
            ...
            Literal3.Text = "<meta name=""description"" content=""" & seocr & Literal5.Text & "到" & LtrDestport.Text & ",航线描述-" & Literal6.Text & ",由" & ds.Tables("user").Rows(0)("CompanyName").ToString & "发布该运费价格.环球运费网提供最新最全面的国际海运拼箱运费运价查询与发布"" />"
        End If
        ...
        Literal20.Text = "<a href=""/lcl/list-" + Literal5.Text + "-" + LtrDestport.Text + "--0-0-0-----1.html"" target=""_blank"">查看全部 " + Literal5.Text + " 至 " + LtrDestport.Text + " 的运价 >></a>"

        If detail_table2 = "TB_YunJiaInfo_bak" Then
            Literal21.Text = "您查看的该条运价的历史快照，<a href=""/lcl/list-" + Literal5.Text + "-" + LtrDestport.Text + "--0-0-0-----1.html"" target=""_blank"">更多同航线运价 >></a>"
        End If

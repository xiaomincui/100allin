<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lcl_detail.aspx.vb" Inherits="search_fcl_detail" EnableViewState="false" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<asp:Literal id="Literal1" runat="server"><title>拼箱海运运价-环球运费网</title></asp:Literal>
<asp:Literal id="Literal3" runat="server"><meta name="description" content="拼箱海运运价-环球运费网" /></asp:Literal>
<asp:Literal id="Literal2" runat="server"><meta name="keywords" content="拼箱海运运价-环球运费网" /></asp:Literal>
...
<tr><td height="10" align="center" ></td></tr>
<tr><td height="10" align="center" ></td></tr>								
<tr><td height="28" align="left" style="line-height:18px; font-size:14px;">亲爱的用户，该运价已被删除或不存在，请点击以下地址，查询更多运价<br/><a href="/lcl/">http://www.100allin.com/lcl/</a></td></tr>
</table>
<br/><br/><br/><br/>
</div>
</div>
...
<li style="width:580px;"><div class="blue_box"><span class="sju">价格(重量):<a><asp:Literal ID="LabGP" runat="server"></asp:Literal></a></span><span class="sju">价格(体积):<a><asp:Literal ID="LabGPV" runat="server"></asp:Literal></a></span></div>
</li>
...
<tr>
<td colspan="13" align="left" style="background: url(http://img02.100allin.com/images2/fcl/qit2.gif) repeat-x top; line-height:20px; padding:9px 0 9px 6px;word-break:break-all; ">目的港：<%=IIf(ddest.ToString = "", "<b style=""color:#ff6600"">全部</b>&nbsp;", "<a href=""/lcl/" & GetQueryString("yid") & "_0.html"">全部</a>")%><asp:Repeater ID="Repeater1" runat="server">
<ItemTemplate><%#IIf(Eval("destport").ToString() = ddest.ToString, "<b style=""color:#ff6600"">" & Eval("destport").ToString() & "</b>&nbsp;", "<a href=""/lcl/" & key(Eval("sid")) & "_" & JingHao(Eval("destport").ToString) & ".html"">" & Eval("destport").ToString().ToUpper() & "</a>")%></ItemTemplate></asp:Repeater></td>
</tr>
<tr style="background-image:url(http://img02.100allin.com/images2/fcl/fjf_bg1.gif)">
<td width="29%" height="26"><strong>目的港</strong></td>
<td width="12%"><strong>价格(重量)</strong></td>
<td width="12%"><strong>价格(体积)</strong></td>
<td width="10%"><strong>附加费</strong></td>
<td width="10%"><strong>航程</strong></td>
<td width="10%"><strong>出发日</strong></td>
...
<td><%#Eval("memo")%></td>                        
<td align="left" bgcolor="#ffffff"><a href="/lcl/list-<%#Eval("startport1")%>-<%#Eval("destport") %>--0-0-0-----1.html" target="_blank">
...
<td height="1" colspan="12" align="left" bgcolor="#F3F3F3"></td>
</tr>
</ItemTemplate>
</asp:Repeater>
<tr>
...
<ItemTemplate>
      <tr>
        <td align="left" width="28%"><a href="/company/<%#key(Eval("userid").ToString)%>/"><img src="/member/logos/<%#Eval("userid").ToString%>.jpg" width="230" height="48" border="0" /></a></td><td align="left" width="72%" style="font-size:14px;"> <a href="/lcl/<%#key(Eval("yunjiaid").ToString)%>_<%#Eval("id").ToString%>.html">价格(重量/体积)：<b style="color:Red;"><%#Eval("pricegp").ToString%>/<%#Eval("pricegpv").ToString%></b>&nbsp;&nbsp;船公司：<b style="color:Red;"><%#Eval("shipcompany").ToString%></b></a>&nbsp;&nbsp;TEL：<%#Eval("phone").ToString%>(<%#Eval("realname").ToString%>)</td>
      </tr>
</ItemTemplate>
</asp:Repeater>                 
    </tbody>
...
<td width="1%"></td>
<td width="29%">标题</td>
<td width="14%">价格(重量)</td>
<td width="14%">价格(体积)</td>
<td width="8%">船公司</td>
...
<td height="32"></td>
<td><a href="/lcl/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#GetFirstString(Eval("title").ToString, 33)%></a></td>
<td><%#GetFirstString(Eval("pricegp").ToString, 5)%></td>
<td><%#GetFirstString(Eval("pricegpv").ToString, 5)%></td>
...
<div class="other_list_left">
<h2><strong>相关拼箱运价</strong><asp:Literal ID="ltrXgLink2" runat="server"></asp:Literal></h2>
<div class="other_list_box">
...
<td><%#GetFirstString(Eval("pricegp").ToString, 8)%></td>
<td><%#GetFirstString(Eval("pricegpv").ToString, 8)%></td>
<td><%#Format(Eval("postdate"), "MM-dd").ToString%> 到 <%#Format(Eval("enddate"), "MM-dd").ToString%></td>
<td><%#GetFirstString(Eval("shipcompany").ToString, 6)%></td>
</tr>
</ItemTemplate>

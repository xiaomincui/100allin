...
Partial Class search_lcl_home
    ...
    Sub LoadBase()
        ...
        Dim sql As String
        sql = ""
        sql = sql + "SELECT top 15 id,startport,destport,title,hangxianmiaoshu,companyname,UserID,pricegp,pricegpv "
        sql = sql + "FROM V_最新_拼箱运价 "
        ...
        sql = ""
        sql = sql + "SELECT lclcount FROM TB_PRICECOUNT "

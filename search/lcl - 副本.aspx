<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lcl.aspx.vb" Inherits="search_lcl"  EnableEventValidation="false" ValidateRequest="false" EnableViewState="false"%><%@ OutputCache Duration="300" VaryByParam="*" VaryByCustom="SessionID" %>
...
<td><asp:TextBox ID="txtStartport" runat="server" Width="180px" sou_type="start_port" Font-Names="Verdana"></asp:TextBox></td>
<td align="right"><strong>目的港</strong>：</td>
<td><asp:TextBox ID="txtDestport" runat="server" Width="180px" sou_type="end_port" Font-Names="Verdana"></asp:TextBox></td>
<%--<td align="right"><strong>船公司</strong>：</td>
<td>--%>
<asp:TextBox ID="txtCarrier" runat="server" Width="100px" sou_type="ship_com" Font-Names="Verdana" Visible="false"></asp:TextBox>
<%--</td>--%>
...
<div class="s_b2_list" style="line-height:31px;">
...
<strong>目的港</strong>： <asp:Label ID="lblDesportHot" runat="server" Text=""></asp:Label><br />
    ...
    <strong>船公司</strong>： <asp:Label ID="lblCarrierHot" runat="server" Text=""></asp:Label></asp:PlaceHolder>
</div>
</div>
...
<asp:Label ID="Label9" runat="server" Text="船公司："></asp:Label><b><asp:Label ID="hidTxtCarrier" runat="server" ></asp:Label></b>&nbsp;</asp:PlaceHolder>
...
<td width="130" align="left"><strong>起运港</strong></td>
<td width="170" align="left"><strong>目的港</strong></td>
<td width="90" align="left"><strong>价格(重量)</strong></td>
<td width="90" align="left"><strong>价格(体积)</strong></td>
...
<ul style="border:1px solid #993333;background:url(/images2/fcl/ico1.jpg) no-repeat right top #f9f4f2;">
...
<tr>
<td colspan="3" id="pop_b_<%# eval("sid") %>_<%# eval("id") %>"><a href="/lcl/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#IIf(Eval("order_advx") = "0", "", "<span style=""color:#971817; font-weight:bold;"">")%><%#GetFirstString(Eval("title").ToString, 40)%><%#IIf(Eval("order_advx") = "0", "", "</span>")%></a>
...
<tr>
<td width="377"><table width="90%" border="0" cellspacing="0" cellpadding="0">
<tr>
...
<tr>
<td class="red_5" width="25%"><%#GetFirstString(Eval("pricegp").ToString, 4)%></td>
<td class="red_5" width="25%"><%#GetFirstString(Eval("pricegpv").ToString, 4)%></td>
</tr>
</table></td>
...
<tr>
<td colspan="3" class="gray_2"><a href="<%#IIf(Eval("userid")="74973","http://www.100allin.com/wsa/","/company/"& key(eval("userid")) & "/")%>" target="_blank" style="color:#666666;"><%#GetFirstString(Eval("companyname").ToString, 50)%></a></td>
</tr>
</table></td>
<td width="105" align="center">
<div><a href="<%#IIf(Eval("userid")="74973","http://www.100allin.com/wsa/","/company/"& key(eval("userid")) & "/")%>" target="_blank" style="color:#666666;"><img src="/images2/fcl/dingc_r62.gif" border="0" title="点击查看联系方式" /></a></div>
</td>
</tr>
</table>
</li>
...
<tr>
<td colspan="3" id="pop_a_<%# eval("sid") %>_<%# eval("id") %>"><a href="/lcl/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#GetFirstString(Eval("title").ToString, 24)%></a>
...
<td width="377"><table width="90%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td width="25%" align="left"><%#Eval("hangxianmiaoshu").ToString%></td>
<td width="35%" align="left" style="line-height:14px;"><%#GetFirstString(IIf(GetQueryString("sp") = "0", Eval("startport").ToString, GetQueryString("sp")), 7).ToUpper()%></td>
<td width="40%" align="left" style="line-height:14px;"><%#GetFirstString(IIf(GetQueryString("dp") = "0", Eval("destport").ToString, GetQueryString("dp")), 20).ToUpper()%></td>
</tr>
</table></td>
<td width="182"><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td class="red_5" width="50%"><%#GetFirstString(Eval("pricegp").ToString, 4)%></td>
<td class="red_5" width="50%"><%#GetFirstString(Eval("pricegpv").ToString, 4)%></td>
</tr>
</table></td>
<td width="63"><span class="gray"><a href="/carrier/carrier-<%#IIf(GetQueryString("cr") = "0", Eval("shipcompany").ToString, GetQueryString("cr"))%>.html"><%#GetFirstString(IIf(GetQueryString("cr") = "0", Eval("shipcompany").ToString, GetQueryString("cr")), 5)%></a></span></td>
</tr>
<tr>
<td colspan="3" class="gray_2"><a href="/company/<%# key(eval("userid"))%>/" target="_blank" style="color:#666666;"><%#GetFirstString(Eval("companyname").ToString, 50)%></a></td>
</tr>
</table></td>
<td width="105" align="center">
...
<a href="http://www.100allin.com/topic/dollar20110913/" target="_blank"><img src="/images2/index/usd20110920_2.jpg" border="0" /></a>
...
<div style="width:950px; float:left; margin-bottom:12px;"><a href="/topic/maersk20111011/"><img src="/images2/2011_fcl/maersk20111011.jpg" border="0" /></a></div>
...
<userbottom100414:userbottom100414 ID="userbottom100414_1" runat="server" />
    ...
    <script type="text/javascript">
//         var abcdefghd = '[{"k":"sh","t":"start_port","s":"","e":"","p":"","c":"上海港--上海<b style=@color:red@>伟胜贤</b>专业拼箱服务","u":"http://www.100allin.com/company/V25pdkNKS2d3OHNzcTd2ajVlY2JsZz09/"},'
//						+ '{"k":"shanghai","t":"start_port","s":"shanghai","e":"","p":"","c":"上海港--上海<b style=@color:red@>伟胜贤</b>专业拼箱服务","u":"http://www.100allin.com/company/V25pdkNKS2d3OHNzcTd2ajVlY2JsZz09/"},'
//                      	+ '{"k":"上海","t":"start_port","s":"上海","e":"","p":"saf","c":"上海港--上海<b style=@color:red@>伟胜贤</b>专业拼箱服务","u":"http://www.100allin.com/company/V25pdkNKS2d3OHNzcTd2ajVlY2JsZz09/"},'         			  
//						+' {}]';
 var abcdefghd = '[{}]';			
    </script>
</form>

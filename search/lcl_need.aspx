<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lcl_need.aspx.vb" Inherits="search_lcl_need" %>
...
<span style="letter-spacing:12px; margin-right:-12px;">航线</span>： <asp:Label ID="lblLineHot" runat="server" Text=""></asp:Label><br />
...
<asp:Label ID="Label1" runat="server" Text="航线："></asp:Label><b><asp:Label ID="hidTxtLine" runat="server" ></asp:Label></b>&nbsp;&nbsp;
...
<LI class="hover"><A style="color:#05233B;" href="/search/lcl_need.aspx">拼箱海运缺失运价</A></LI>
<LI><A href="/search/air_need.aspx">空运缺失运价</A></LI>
</UL>
</DIV>
...
<td width="16%"><a href="/member/SpellRelease.aspx?startport=<%#Server.UrlEncode(Eval("STARTPORT").ToString)%>&destport=<%#Server.UrlEncode(Eval("DESTPORT").ToString)%>&hx=<%#Server.UrlEncode(Eval("LINE").ToString)%>&shipcompany=<%#Server.UrlEncode(Eval("CARRIER").ToString)%>" target="_blank">添加这条运价</a></td>
</tr>
</table>
</li>
</ul>

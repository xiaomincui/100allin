...
public partial class search_lcl_order : System.Web.UI.Page
{
    public string pub_f = "";
    ...
    public void LoadNewOrder()
    {
        ...
        txtCode.Value = "LCL" + DateTime.Now.ToString("yyMMddHHmm") + GetFourDigits(Convert.ToInt32(10000 * rd.NextDouble()).ToString());
        ...
        {
            sql += "SELECT * FROM TB_YUNJIA,TB_YUNJIAINFO ";
            sql += "WHERE TB_YUNJIA.id = TB_YUNJIAINFO.yunjiaid ";
            sql += "AND TB_YUNJIA.id = " + ck.CheckNumber(Request.QueryString["yid"]) + " ";
            sql += "ORDER BY TB_YUNJIAINFO.id desc";
        }
        else
        {
            sql += "SELECT * FROM TB_YUNJIA,TB_YUNJIAINFO ";
            sql += "WHERE TB_YUNJIA.id = TB_YUNJIAINFO.yunjiaid ";
            sql += "AND TB_YUNJIAINFO.id = " + ck.CheckNumber(Request.QueryString["ydid"]);
        }
        ...
        ltrFreightDetail.Text = "<b style=\"font-size:14px; font-weight:bold;\"><b id='f20gp' style=\"color:#FF0000;\">" + ds.Tables["yunjia"].Rows[0]["pricegp"].ToString() + "</b>&nbsp;/&nbsp;<b id='f40gp' style=\"color:#FF0000;\">" + ds.Tables["yunjia"].Rows[0]["pricegpv"].ToString() + "</b>&nbsp;&nbsp;&nbsp;&nbsp;<b id='f40hq' style=\"color:#FF0000;\">" + ds.Tables["yunjia"].Rows[0]["price40hq"].ToString() + "</b></b>";
    ...
    public void LoadEditOrder()
    {
        ...
        ltrOrderStatus.Text = "<div style=\"padding:20px; margin-top:10px; font-size:14px; line-height:30px; text-align:center; background:#FFFCF3;border:1px solid #F7E4A5;\">修改订舱单</div>";
        ...
        txt20gp.Value = ds.Tables["order"].Rows[0]["lcl_cbm"].ToString();
        ...
        if (ds.Tables["order"].Rows[0]["freight_code1"].ToString() == "0")
        {
            sql += "SELECT * FROM TB_YUNJIA,TB_YUNJIAINFO ";
            sql += "WHERE TB_YUNJIA.id = TB_YUNJIAINFO.yunjiaid ";
            sql += "AND TB_YUNJIA.id = " + ds.Tables["order"].Rows[0]["freight_code"].ToString() + " ";
            sql += "ORDER BY TB_YUNJIAINFO.id desc";
        }
        else
        {
            sql += "SELECT * FROM TB_YUNJIA,TB_YUNJIAINFO ";
            sql += "WHERE TB_YUNJIA.id = TB_YUNJIAINFO.yunjiaid ";
            sql += "AND TB_YUNJIAINFO.id = " + ds.Tables["order"].Rows[0]["freight_code1"].ToString();
        }
        ...
        ltrFreightDetail.Text = "<b style=\"font-size:14px; font-weight:bold;\"><b id='f20gp' style=\"color:#FF0000;\">" + ds1.Tables["yunjia"].Rows[0]["pricegp"].ToString() + "</b>&nbsp;/&nbsp;<b id='f40gp' style=\"color:#FF0000;\">" + ds1.Tables["yunjia"].Rows[0]["pricegpv"].ToString() + "</b>&nbsp;&nbsp;&nbsp;&nbsp;<b id='f40hq' style=\"color:#FF0000;\">" + ds1.Tables["yunjia"].Rows[0]["price40hq"].ToString() + "</b></b>";
        ...
        //ltrHyf.Text = (Convert.ToInt32(txt20gp.Value) * Convert.ToInt32(ds1.Tables["yunjia"].Rows[0]["price20gp"].ToString()) + Convert.ToInt32(txt40gp.Value) * Convert.ToInt32(ds1.Tables["yunjia"].Rows[0]["price40gp"].ToString()) + Convert.ToInt32(txt40hq.Value) * Convert.ToInt32(ds1.Tables["yunjia"].Rows[0]["price40hq"].ToString())).ToString();
    }//载入要修改的订单
    ...
    public void LoadSavedOrder()
    {
        ...
        if (u == ds.Tables["order"].Rows[0]["order_shipper"].ToString())
        {
            PlaceHolder3.Visible = true;
            PlaceHolder1.Visible = false;
            ltrOrderStatus.Text = "<div style=\"padding:20px; margin-top:10px; font-size:14px; line-height:30px; text-align:left; background:#FFFCF3;border:1px solid #F7E4A5;\">" + ds.Tables["order"].Rows[0]["status_txt_shipper"].ToString().Replace("{1}", ck.CheckInput(GetRequestQueryString("orderid", "0"))).Replace("{9}","lcl") + "</div>";
        }//订舱方显示的文本

        if (u == ds.Tables["order"].Rows[0]["order_forward"].ToString())
        {
            PlaceHolder4.Visible = true;
            ltrOrderStatus.Text = "<div style=\"padding:20px; margin-top:10px; font-size:14px; line-height:30px; text-align:left; background:#FFFCF3;border:1px solid #F7E4A5;\">" + ds.Tables["order"].Rows[0]["status_txt_forward"].ToString().Replace("{1}", ck.CheckInput(GetRequestQueryString("orderid", "0"))).Replace("{9}", "lcl") + "</div>";
        }//承运方显示的文本

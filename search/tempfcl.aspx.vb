...
Partial Class search_tempfcl
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ltrTotalSurcharge.Text = "<li>·<a href=""/baf/"" target=""_blank"">" & Now.Month.ToString & "月各大船公司最新BAF/CAF</a></li>"
        ltrTotalSurcharge.Text += "<li>·<a href=""/thc/"" target=""_blank"">" & Now.Month.ToString & "月各大船公司最新THC</a></li>"
        ltrTotalSurcharge.Text += "<li>·<a href=""/orc/"" target=""_blank"">" & Now.Month.ToString & "月最新ORC</a></li>"

...
Partial Class search_air_new
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For i As Integer = 0 To 14
            ...
            Else
                lblStartportHot.Text = lblStartportHot.Text & "&nbsp;&nbsp;&nbsp;" & "<a href=""/search/air_new.aspx?sp=" & StartportHotArray(i).Split(",")(1) & "&dp=&cr=" & cr & "&l=" & l & "&order=" & order & "&p=1"">" & StartportHotArray(i).Split(",")(0) & "</a>"
            End If
        Next
        ...
        Else
            lblStartportHot.Text = "&nbsp;&nbsp;&nbsp;" & "<a href = ""/search/air_new.aspx?sp=&dp=&cr=&l=" & l & "&order=&p=1"">全部</a>" & lblStartportHot.Text
        End If
        ...
        For i As Integer = 0 To 7
            ...
            Else
                lblLineHot.Text = lblLineHot.Text & "&nbsp;&nbsp;&nbsp;" & "<a href=""/search/air_new.aspx?sp=" & sp & "&dp=&cr=" & cr & "&l=" & LineHotArray(i).Split(",")(1) & "&order=" & order & "&p=1"">" & LineHotArray(i).Split(",")(0) & "</a>"
            End If
        Next
    ...
    Sub LoadRecord(ByVal page As String)
        ...
        If dp = "" And cr = "" Then
            sqlwords1 = sqlwords1 & "insert #Tmp (yunjiainfoid,userid,postdate) ("
            sqlwords1 = sqlwords1 & "select airid,userid,postdate from TB_Yunjia_Effective_10 "
            sqlwords1 = sqlwords1 & "where 1=1 "
            If line <> "" Then
        ...
        Else
            sqlwords1 = sqlwords1 & "insert #Tmp (yunjiainfoid,userid,postdate) ("
            sqlwords1 = sqlwords1 & "select AIRPRICEID,userid,postdate from TB_YunjiaInfo_Effective_10,TB_Yunjia_Effective_10 "
            sqlwords1 = sqlwords1 & "where TB_Yunjia_Effective_10.airid = TB_YunjiaInfo_Effective_10.airid AND 1=1 "
            If startport <> "" Then
                If dsfrom.Tables("city").Rows.Count > 0 Then
                    sqlwords1 = sqlwords1 & "AND ("
                    For i As Integer = 0 To startportlist.Count - 1
        ...
        If history = "0" Then
            ltrMoreHistory.Text = "<a href=""/search/air_new.aspx?sp=" & sp & "&dp=" & dp & "&cr=" & cr & "&l=" & l & "&order=" & order & "&history=1&p=1""><img src= ""/images2/2011_fcl/history_freight.gif"" border=""0""/></a>"
            ltrMoreHistory1.Text = "<a href=""/search/air_new.aspx?sp=" & sp & "&dp=" & dp & "&cr=" & cr & "&l=" & l & "&order=" & order & "&history=1&p=1"">查看历史运价</a>"
        Else
            ltrMoreHistory1.Text = "您搜索的是历史运价，<a href=""/search/air_new.aspx?sp=" & sp & "&dp=" & dp & "&cr=" & cr & "&l=" & l & "&order=" & order & "&p=1"">查看有效运价</a>"
            ltrMoreHistory.Text = "<a href=""/search/air_new.aspx?sp=" & sp & "&dp=" & dp & "&cr=" & cr & "&l=" & l & "&order=" & order & "&p=1""><img src= ""/images2/2011_fcl/effective_freight.gif"" border=""0""/></a>"
        End If
        ...
        Dim base_url As String = "/search/air_new.aspx?sp=" & sp & "&dp=" & dp & "&cr=" & cr & "&l=" & l & "&order=" & order & "&history=" & history & "&p="
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        If txtDestport.Text <> "" Then
            Response.Redirect("/search/air_new.aspx?sp=" & txtStartport.Text & "&dp=" & txtDestport.Text.ToUpper & "&cr=&l=0&p=1&order=0")
        Else
            Response.Redirect("/search/air_new.aspx?sp=" & txtStartport.Text & "&dp=" & txtDestport.Text.ToUpper & "&cr=&l=" & txtLine.SelectedIndex.ToString & "&p=1&order=0")
        End If

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fcl_test.aspx.vb" Inherits="search_fcl_test" EnableEventValidation="false" ValidateRequest="false" EnableViewState="false"%><%@ OutputCache Duration="300" VaryByParam="*" VaryByCustom="SessionID" %>
...
<td><asp:TextBox ID="txtCarrier" runat="server" Width="100px" sou_type="ship_com" Font-Names="Verdana"></asp:TextBox></td>
...
<td width="80" align="left"><strong>起运港</strong></td>
<td width="121" align="left"><strong>目的港</strong></td>
...
<td width="154" align="left"><strong>订舱保证</strong></td>
</tr>
</table></td>
...
<td width="552" onmouseover="tt2('<%#Rptfcladv.Items.Count %>','pop_b_<%# eval("sid") %>_<%# eval("id") %>',event)" onmouseout="hidden(event)"><table width="552" height="80" border="0" cellpadding="0" cellspacing="0">
<tr>
<td colspan="3" id="pop_b_<%# eval("sid") %>_<%# eval("id") %>"><a href="/fcl/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#IIf(Eval("order_advx") = "0", "", "<span style=""color:#971817; font-weight:bold;"">")%><%#GetFirstString(Eval("title").ToString, 40)%><%#IIf(Eval("order_advx") = "0", "", "</span>")%></a>
...
<td width="34%" style="line-height:14px;"><%#GetFirstString(Eval("startport").ToString, 7).ToUpper()%></td>
...
<tr>
<td colspan="3" class="gray_2"><a href="<%#IIf(Eval("userid")="73066","http://www.100allin.com/waysglobal/","/company/"& key(eval("userid")) & "/")%>" target="_blank" style="color:#666666;"><%#GetFirstString(Eval("companyname").ToString, 50)%></a><a href="/company/<%# key(eval("userid"))%>/" target="_blank"><%#Star1(Eval("star_allin").ToString)%></a>&nbsp;
...
<tr>
<td height="24" align="center" bordercolor="0"><a href="/help/services_1.aspx" style="display:<%#IIf (CInt(Eval("star_allin").ToString) = 5,"","none")%>" ><img src="/images/fcl/fc_r5_c1.gif" width="69" height="18" border="0" /></a></td>
</tr>
</table></td>
<td width="105" align="center">
<div style="margin-bottom:5px;display:<%#IIf (CInt(Eval("star_allin").ToString) <> 0,"","none")%>"><a href="/search/order_temp.aspx?type=fcl&filter=new&yid=<%# Eval("sid") %>&ydid=<%# Eval("id") %>&f=<%# Eval("userid") %>" target="_blank"  onmouseover="tt_dcpop(event);" onmouseout="hid_dcpop();"><img src="/images/fcl/dingc_r5_c1.jpg" width="68" height="29" border=0 /></a></div>
...
<td width="552" onmouseover="tt('<%#Rptfcl.Items.Count %>','pop_a_<%# eval("sid") %>_<%# eval("id") %>',event)" onmouseout="hidden(event)"><table width="552" height="80" border="0" cellpadding="0" cellspacing="0">
<tr>
...
<td width="105" align="center">
<div style="margin-bottom:5px;display:<%#IIf (CInt(Eval("star_allin").ToString) <> 0,"","none")%>"><a href="/search/order_temp.aspx?type=fcl&filter=new&yid=<%# Eval("sid") %>&ydid=<%# Eval("id") %>&f=<%# Eval("userid") %>" target="_blank"  onmouseover="tt_dcpop(event);" onmouseout="hid_dcpop();"><img src="/images/fcl/dingc_r5_c1.jpg" width="68" height="29" border=0 /></a></div>
<div><a href="<%#IIf(Eval("userid")="73066","http://www.100allin.com/waysglobal/","/company/"& key(eval("userid")) & "/")%>" target="_blank" style="color:#666666;"><img src="/images2/fcl/dingc_r62.gif" border="0" title="点击查看联系方式" /></a></div></td>
</tr>
</table>
</li>
</ul>
...
<div class="r_hot_md">
<a href="/fcl/list-QINGDAO-DUBAI--0-0-0-----1.html">QINGDAO - DUBAI</a><br />
<a href="/fcl/list-SHANGHAI-PORT KELANG--0-0-0-----1.html">SHANGHAI - PORT KELANG</a><br />
<a href="/fcl/list-SHANGHAI-NHAVA SHEVA--0-0-0-----1.html">SHANGHAI - NHAVA SHEVA</a><br />
<a href="/fcl/list-SHANGHAI-KARACHI--0-0-0-----1.html">SHANGHAI - KARACHI</a><br />
<a href="/fcl/list-SHANGHAI-HAMBURG--0-0-0-----1.html">SHANGHAI - HAMBURG</a><br />
<a href="/fcl/list-SHANGHAI-BANGKOK--0-0-0-----1.html">SHANGHAI - BANGKOK</a><br />
<a href="/fcl/list-SHANGHAI-MANZANILLO--0-0-0-----1.html">SHANGHAI - MANZANILLO</a><br />
<a href="/fcl/list-SHANGHAI-SINGAPORE--0-0-0-----1.html">SHANGHAI - SINGAPORE</a><br />		
</div>

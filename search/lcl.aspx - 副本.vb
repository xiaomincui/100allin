Partial Class search_lcl
    ...
    Sub LoadRecord(ByVal page As String)
        ...
        If ((startport.ToLower = "ningbo" Or startport = "宁波") And (line = "日韩线" Or line1 = "日韩线" Or line = "近洋线" Or line1 = "近洋线")) Then
            'ltrBanner.Text = "<div class=""right_ad""><a href=""/shop/hf/"" target=""_blank""><img src=""http://img02.100allin.com/images2/banner/xhf.jpg"" width=""200"" height=""120"" border=""0"" /></a></div>"
        End If

        If (line = "近洋线" Or line1 = "近洋线" Or line = "中东印巴线" Or line1 = "中东印巴线") Then

        End If
        'ltrBanner.Text = "<div class=""right_ad""><a href=""/wsa/"" target=""_blank""><img src=""http://img02.100allin.com/images2/banner/wsx.jpg"" width=""200"" border=""0"" /></a></div>"

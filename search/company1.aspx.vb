...
Partial Class search_company
    ...
    Public Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            '=======================================================================
            Dim specialServiceArray(6) As String
    ...
    Sub LoadRecord(ByVal page As String)
        ...
        sql = sql & "(SELECT TOP " & item.ToString & " userid,(CASE WHEN Login2_Adventage_Line_Adv like '%" & l & "%' THEN 1 ELSE 0 END) AS ifend "
        sql = sql & "FROM "
        sql = sql & "V_COMPANY_USER "
        sql = sql & "WHERE "
        sql = sql & "1=1 AND ifcompanyshow = 1 "

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fcl_need.aspx.vb" Inherits="search_fcl_need" %>
...
<DIV class="menu2box">
<UL id="menu2">
<LI class="hover"><A style="color:#05233B;" href="/search/fcl_need.aspx">整箱海运缺失运价</A></LI>
...
<td width="16%"><a href="/member/Release.aspx?startport=<%#Server.UrlEncode(Eval("STARTPORT").ToString)%>&destport=<%#Server.UrlEncode(Eval("DESTPORT").ToString)%>&hx=<%#Server.UrlEncode(Eval("LINE").ToString)%>&shipcompany=<%#Server.UrlEncode(Eval("CARRIER").ToString)%>" target="_blank">添加这条运价</a></td>
</tr>
</table>
</li>
</ul>

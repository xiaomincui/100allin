<%@ Page Language="VB" AutoEventWireup="false" CodeFile="company1.aspx.vb" Inherits="search_company" EnableEventValidation="false" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
			  	...
			  	<div class="company_box">
					...
					<asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline">
                        ...
                        <asp:TextBox ID="txtLineAir" runat="server" Visible="false"></asp:TextBox>&nbsp;&nbsp;
                                ...
                                <asp:Label ID="Label2" runat="server" ForeColor="#CCCCCC" Visible="false">特殊服务：&nbsp;<b>全部</b>&nbsp;&nbsp;冷冻冷藏&nbsp;&nbsp;危险品&nbsp;&nbsp;罐箱&nbsp;&nbsp;其他特种柜&nbsp;&nbsp;散杂货船&nbsp;&nbsp;进口 </asp:Label>
							    </asp:PlaceHolder> 
							    </p>
					  </DIV>	  
			</DIV>
									...
									<li>
									  <table width="100%" border="0" cellspacing="1" cellpadding="0">
										<tr>
										  ...
										  <td width="10%" align="left"  class="picSmall"><a href="<%#IIf(Eval("userid")="73066","http://www.100allin.com/waysglobal/",IIf(Eval("userid")="74973","http://www.100allin.com/wsa/","/company/"& key(eval("userid")) & "/"))%>" target="_blank"><img src="/member/Head/<%#IIf(CBool(Eval("HeadURL").ToString()) = True,Eval("userid").ToString(),"default")%>.jpg" width="70" height="70" border="0" /></a></td>
										  <td width="38%"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                            <tr>
                                              <td height="25"><a href="<%#IIf(Eval("userid")="73066","http://www.100allin.com/waysglobal/",IIf(Eval("userid")="74973","http://www.100allin.com/wsa/","/company/"& key(eval("userid")) & "/"))%>" target="_blank" <%#IIf(Eval("ifend").ToString()="1","style='color:#971817;'","")%>><strong><%#Eval("CompanyName").ToString()%></strong></a><%#IIf(Eval("ifend") = "0", "", "<img src=""http://img02.100allin.com/images2/fcl/02270434.gif"" width=""30"" height=""13"" title=""环球运费网推荐"" />")%></td>
                                            </tr>
                                            <tr>
  ...
  <tr>
    ...
    <input id="btnPageJump" name="btnPageJump" type="button" value="确定" style=" width:40px; height:20px;" runat="server"/>
			...
			<div class="main_right"><!--右边开始-->
						<div style="margin-bottom:5px;"><a href="/supplier/" target="_blank"><img src="http://img02.100allin.com/images2/index/zm.gif" width="200" height="120" border="0" /></a></div>
			  ...
			  <div style="float:left; margin-bottom:15px;"><a href="/topic/order20091104/product_1.aspx" target="_blank"><img src="/images/company/company_bt2.gif" border="0" /></a></div>
			  <div class="right_boxs">

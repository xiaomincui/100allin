<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bar3.aspx.vb" Inherits="search_bar3" %>
			  		...
			  		<tr>
						<td>
                                <div style="margin-bottom:4px; line-height:22px;">
                                    ...
                                    <input id="tt2" type="radio" name="tt" value="找拼箱运价" onclick="dyts3.showtab(1);"/><label for="tt2" style="font-size:13px;">海运拼箱</label><BR/>
					      ...
					      <td valign="top">
					        <div>
							  <table border="0" cellspacing="3" cellpadding="1" id="s1" style="display:none">
                                <tr>
                                  <td width="47">航线</td>
                                  <td width="130"><asp:DropDownList ID="txtLine" runat="server" Width="96px" Font-Size="12px">
                                ...
                                <tr>
                                  <td>启运港</td>
                                  <td><asp:TextBox ID="txtStartport" runat="server" Width="90px" Height="14px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                  <td>目的港</td>
                                  <td><asp:TextBox ID="txtDestport" runat="server" Width="90px" Height="14px"></asp:TextBox></td>
                                </tr>
                                <tr>
							  ...
							  <table border="0" cellspacing="3" cellpadding="1" id="s2" style="display:none">
                                <tr>
                                  <td width="47">航线</td>
                                  <td width="130">
									<asp:DropDownList ID="txtLine2" runat="server" Width="96px" Font-Size="12px">
										<asp:ListItem Text="全部航线" Value=""></asp:ListItem>
										<asp:ListItem>美加线</asp:ListItem>
										<asp:ListItem>欧地线</asp:ListItem>
										<asp:ListItem>中南美线</asp:ListItem>
                                ...
                                <tr>
                                  <td>启运港</td>
                                  <td><asp:TextBox ID="txtStartport2" runat="server" Width="90px" Height="14px"></asp:TextBox>                                  </td>
                                </tr>
                                <tr>
                                  <td>目的港</td>
                                  <td><asp:TextBox ID="txtDestport2" runat="server" Width="90px" Height="14px"></asp:TextBox>                                  </td>
                                </tr>
                                <tr>
							...
							<table border="0" cellspacing="3" cellpadding="1" id="s3" style="display:none">
                                <tr>
                                  <td width="47">航线</td>
                                  <td width="130">
									<asp:DropDownList ID="txtLine3" runat="server" Width="96px" Font-Size="12px">
                                        <asp:ListItem Text="全部航线" Value=""></asp:ListItem>
                                ...
                                <tr>
                                  <td>启运港</td>
                                  <td><asp:TextBox ID="txtStartport3" runat="server" Width="90px" Height="14px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                  <td>目的港</td>
                                  <td><asp:TextBox ID="txtDestport3" runat="server" Width="90px" Height="14px"></asp:TextBox></td>
                                </tr>
                                <tr>

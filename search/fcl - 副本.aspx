<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fcl.aspx.vb" Inherits="search_fcl" EnableEventValidation="false" ValidateRequest="false" EnableViewState="false"%><%@ OutputCache Duration="300" VaryByParam="*" VaryByCustom="SessionID" %>
...
<div style="margin-bottom:10px;display:none;"><a href="http://www.100allin.com/company/Y0lmRlZhMzNsTzIzVGU4eDd1eENNUT09/" target="_blank"><img src="http://img02.100allin.com/images2/banner/galax.jpg" width="950" height="92" border="0" /></a></div>
<div class="notice"><p>
...
<asp:Literal ID="ltrBanner2" runat="server"></asp:Literal>

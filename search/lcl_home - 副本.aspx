...
<script type="text/javascript" language="javascript" src="/js/auto/ac_zd_head_lcl.js"></script>
				...
				<div class="s_bar_mp">
				  <table width="890" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td><asp:TextBox ID="txtStartport" runat="server" Width="180px" sou_type="start_port"></asp:TextBox></td>
                      <td align="right"><strong>目的港</strong>：</td>
                      <td><asp:TextBox ID="txtDestport" runat="server" Width="180px" sou_type="end_port"></asp:TextBox></td>
<%--                      <td align="right"><strong>船公司</strong>：</td>
                      <td>--%>
                      <asp:TextBox ID="txtCarrier" runat="server" Width="100px" sou_type="ship_com" Visible="false"></asp:TextBox>
<%--                      </td>--%>
		...
		<div class="freight_List_title" style="background:url(/images2/2011_fcl/btbar_top.jpg) no-repeat top; height:35px; padding:0px; line-height:35px;">
		 	 <h2>拼箱海运价列表</h2>
            &nbsp;<a href="/member/releaseselect.aspx" target="_blank">我要发布运价</a><img style="margin-right:3px; margin-left:440px;" src="/images2/fcl/whao.gif" /><a href="/help/help_fcl.html#tips" target="_blank">相关帮助</a>	  </div>
		<div class="biaoti">
              ...
              <tr>
                ...
                <td background="/images2/2011_fcl/btbar_bg.jpg"><table width="730" border="0" cellpadding="0" cellspacing="1">
                  <tr>
                    ...
                    <td width="181" align="left"><strong>运价(重量<b>|</b>体积)</strong></td>
				...
				<div class="freight_List">
					  ...
					  <li style="background:url(/images2/2011_fcl/li_bg.jpg) repeat-x bottom;">
					    <table width="730" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td width="80" align="left"><div class="lcl_price_detail"><%#output(Eval("pricegp").ToString())%></div></td>
                            <td width="20" align="left"><b>|</b> </td>
                            <td width="80" align="left"><div class="lcl_price_detail"><%#output(Eval("pricegpv").ToString())%></div></td>                         
				  ...
				  <div class="page_head">共有<asp:Literal ID="Literal1" runat="server"></asp:Literal>条拼箱海运价</div>
				  <div class="page">
						<span class="selected">1</span>
						<a href="/lcl/list----0-0-0-----2.html">2</a>
						<a href="/lcl/list----0-0-0-----3.html">3</a>
						<a href="/lcl/list----0-0-0-----4.html">4</a>
						<a href="/lcl/list----0-0-0-----5.html">5</a>
						<a href="/lcl/list----0-0-0-----6.html">6</a>
						<a href="/lcl/list----0-0-0-----7.html">7</a>
						<a href="/lcl/list----0-0-0-----8.html">8</a>
						<a href="/lcl/list----0-0-0-----9.html">9</a>
						<a href="/lcl/list----0-0-0-----10.html">10</a>
						<span>...</span>
						<a class="next" href="/lcl/list----0-0-0-----1.html" style="padding:2px 12px 2px 6px;">下一页</a>				  
<%--						<a class="next" href="/lcl/list----0-0-0-----1.html" style="padding:2px 12px 2px 6px;">更多拼箱海运价</a>--%>
				  </div>
				</div>
			...
			<div class="r_nav">
				...
				<div class="r_nav_md">
					...
					<ul>
					  ...
					  <P><a href = "/lcl/list----0-0-0-----1.html">全部</a>&nbsp;<a href = "/lcl/list-shanghai---0-0-0-----1.html">上海</a>&nbsp;<a href = "/lcl/list-ningbo---0-0-0-----1.html">宁波</a>&nbsp;<a href = "/lcl/list-shenzhen---0-0-0-----1.html">深圳</a>&nbsp;<a href = "/lcl/list-qingdao---0-0-0-----1.html">青岛</a>&nbsp;<br/><a href = "/lcl/list-tianjin---0-0-0-----1.html">天津</a>&nbsp;<a href = "/lcl/list-guangzhou---0-0-0-----1.html">广州</a>&nbsp;<a href = "/lcl/list-xiamen---0-0-0-----1.html">厦门</a>&nbsp;<a href = "/lcl/list-dalian---0-0-0-----1.html">大连</a>&nbsp;<a href = "/lcl/list-lianyungang---0-0-0-----1.html">连云港</a><br/><a href = "/lcl/list-nanjing---0-0-0-----1.html">南京</a>&nbsp;<a href = "/lcl/list-zhuhai---0-0-0-----1.html">珠海</a>&nbsp;<a href = "/lcl/list-hongkong---0-0-0-----1.html">香港</a>&nbsp;<a href = "/lcl/list-shantou---0-0-0-----1.html">汕头</a>&nbsp;<a href = "/lcl/list-fuzhou---0-0-0-----1.html">福州</a><br/><a href = "/lcl/list-zhongshan---0-0-0-----1.html">中山</a>&nbsp;<a href = "/lcl/list-fangcheng---0-0-0-----1.html">防城</a>&nbsp;<a href="javascript:;" id="linkmore" onclick="showmore('','','0');">更多...</a>
</P>
					  <h3><img src="/images2/2011_fcl/ico2.gif" />选择航线</h3>
					  <P><a href = "/lcl/list----0-0-0-----1.html">全部</a>&nbsp;<a href = "/lcl/list----1-0-0-----1.html">美加线</a>&nbsp;<a href = "/lcl/list----6-0-0-----1.html">非洲线</a>&nbsp;<a href = "/lcl/list----3-0-0-----1.html">中南美线</a><br/><a href = "/lcl/list----2-0-0-----1.html">欧地线</a>&nbsp;<a href = "/lcl/list----4-0-0-----1.html">日韩线</a>&nbsp;<a href = "/lcl/list----5-0-0-----1.html">近洋线</a>&nbsp;<a href = "/lcl/list----7-0-0-----1.html">澳洲线</a><br/><a href = "/lcl/list----8-0-0-----1.html">中东印巴线</a>&nbsp;<a href = "/lcl/list----9-0-0-----1.html">红海线</a></P>
<%--					  <h3><img src="/images2/2011_fcl/ico3.gif" />选择船公司</h3>
					  <P><a href = "/lcl/list----0-0-0-----1.html">全部</a>&nbsp;<a href = "/lcl/list---MSK-0-0-0-----1.html">马士基</a>&nbsp;<a href = "/lcl/list---MSC-0-0-0-----1.html">地中海</a>&nbsp;<a href = "/lcl/list---KLINE-0-0-0-----1.html">川崎</a><br/><a href = "/lcl/list---EMC-0-0-0-----1.html">长荣</a>&nbsp;<a href = "/lcl/list---PIL-0-0-0-----1.html">太平</a>&nbsp;<a href = "/lcl/list---CSCL-0-0-0-----1.html">中海</a>&nbsp;<a href = "/lcl/list---OOCL-0-0-0-----1.html">东方海外</a><br/><a href = "/lcl/list---CMA-0-0-0-----1.html">达飞</a>&nbsp;<a href = "/lcl/list---COSCO-0-0-0-----1.html">中远</a>&nbsp;<a href = "/lcl/list---ZIM-0-0-0-----1.html">以星</a>&nbsp;<a href = "/lcl/list---YML-0-0-0-----1.html">阳明</a>&nbsp;<a href = "/lcl/list---WHL-0-0-0-----1.html">万海</a><br/><a href = "/lcl/list---APL-0-0-0-----1.html">美国总统</a>&nbsp;<a href = "/lcl/list---CSAV-0-0-0-----1.html">南美邮船</a>&nbsp;<a href = "/lcl/list---HMM-0-0-0-----1.html">现代</a>&nbsp;<a href = "/lcl/list---HANJIN-0-0-0-----1.html">韩进</a><br/><a href="javascript:;" id="linkmorecr" onclick="showmorecr('','','0');">更多...</a>
</P>--%>
...
<ItemTemplate>
<a href="/lcl/list-<%#Eval("startport").ToString() %>-<%#Eval("destport").ToString() %>--0-0-0-----1.html"><%#Eval("startport").ToString()%> - <%#Eval("destport").ToString()%></a><br />	
</ItemTemplate>
</asp:Repeater>								
                </div>

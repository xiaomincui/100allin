...
public partial class search_lcl_order : System.Web.UI.Page
{
    ...
    public void LoadNewOrder()
    {
        ...
        {
            fdetail = AllinFreight1.GetFreightDetail("9", ck.CheckNumber(Request.QueryString["yid"]), "0");
        }
        else
        {
            fdetail = AllinFreight1.GetFreightDetail("9", "0", ck.CheckNumber(Request.QueryString["ydid"]));
        }
        ...
        ltrFreightGP.Text = fdetail[40];
        ltrFreightGPV.Text = fdetail[41];
    ...
    {
        AllinOrder1.UpdateOrderPriceLcl(check1.CheckInput(GetRequest1.GetRequestQueryString("orderid", "0")), check1.CheckInput(txt_edit_pricegp.Text), check1.CheckInput(txt_edit_pricegpv.Text), check1.CheckInput(txt_edit_price_shipcompany.Text));

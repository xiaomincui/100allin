<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lcl_order.aspx.cs" Inherits="search_lcl_order" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>订舱单</title>
<link href="/css/booking0118.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="/css/lcl_order.css" />
<link rel="stylesheet" type="text/css" href="/js/date/css/w.css" />
<style type="text/css">
</style>
<script type="text/javascript" src="/js/lcl_order.js"></script>
...
function editPrice(){
    document.getElementById("txt_edit_pricegp").className = "";
    document.getElementById("txt_edit_pricegpv").className = "";
    document.getElementById("txt_edit_price_shipcompany").className = "";
    
    document.getElementById("fgp").style.display = "none";
    document.getElementById("fgpv").style.display = "none";
...
function cancelEditPrice(){
    document.getElementById("txt_edit_pricegp").className = "hidden";
    document.getElementById("txt_edit_pricegpv").className = "hidden";
    document.getElementById("txt_edit_price_shipcompany").className = "hidden";
    
    document.getElementById("fgp").style.display = "";
    document.getElementById("fgpv").style.display = "";
...
<asp:PlaceHolder ID="phOrderView" runat="server">
  ...
  Marks & Numbers</td>
        ...
        <td width="140" height="31" align="center"><span class="red">*</span><strong> 毛重(TON)</strong>：<br />
          Gross Weight</td>
	  ...
	  <tr>
	    ...
	    <td height="31" colspan="4" align="left"><table border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        ...
	        <td width="45">&nbsp;<strong>CBM</strong></td>
	        </tr>
	      </table></td>
...
//]]>
	  ...
	  <tr>
	    ...
	    <td height="31" colspan="4" align="left"><table border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td width="38"><input id="txtgp" value="0" class="ipt8" size="4" runat="server" readonly="readonly"/></td>
	        <td width="45">&nbsp;<strong>CBM</strong></td>
	        </tr>
	      </table></td>
      ...
      <tr>
        <td height="31" align="left"><table width="796" border="0" cellpadding="0" cellspacing="0">
          <tr style="background:url(/images/fcl/order_biaoti_bg2.gif)">
            ...
            <td width="100"><strong>运费(按重量)</strong></td>
            <td width="100"><strong>运费(按体积)</strong></td>
          ...
          <tr>
            ...
            <td><asp:TextBox ID="txt_edit_pricegp" runat="server" Width="40" CssClass="hidden"></asp:TextBox><strong><span id='fgp'><asp:Literal ID="ltrFreightGP" runat="server"></asp:Literal></span></strong></td>
            <td><asp:TextBox ID="txt_edit_pricegpv" runat="server" Width="40" CssClass="hidden"></asp:TextBox><strong><span id='fgpv'><asp:Literal ID="ltrFreightGPV" runat="server"></asp:Literal></span></strong></td>
  ...
  <tr>
    ...
    <br/>
     3.轻重货判断标准为：1CBM：1000KGS，如果您出货的航线港口重轻货比例不同，将以接受方最终修改的标准为准。<br/>
    <br/>
    </span>
    </asp:PlaceHolder>
...
货量：<span id="spangp" style="color:Green; font-weight:bold;"></span> CBM<br/>

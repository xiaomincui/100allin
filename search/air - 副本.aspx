...
<div class="notice"><p>
共找到<span class="orange"><asp:Label ID="hidTotalItem" runat="server" ></asp:Label></span>条<asp:Literal ID="ltrMoreHistory2" runat="server"></asp:Literal>
...
<asp:HiddenField ID="hidHistroy" runat="server" Value="1" />
</p>
</div>
<div class="main_left">
...
<td width="622" onmouseover="tt2('<%#Rptfcladv.Items.Count %>','pop_a_<%# eval("sid") %>_<%# eval("id") %>',event)" onmouseout="hidden(event)"><table width="622" height="80" border="0" cellpadding="0" cellspacing="0">
<tr>
<td colspan="2" id="pop_a_<%# eval("sid") %>_<%# eval("id") %>"><a href="/air/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><span style="color:#971817; font-weight:bold;"><%#GetFirstString(Eval("title").ToString, 24)%></a></span>
<span class="gray_2">[<%#Format(Eval("postdate"), "yy").ToString%>/<%#Format(Eval("postdate"), "MM").ToString%>/<%#Format(Eval("postdate"), "dd").ToString%> 至 <%#Format(CDate(Eval("enddate")), "yy").ToString%>/<%#Format(CDate(Eval("enddate")), "MM").ToString%>/<%#Format(CDate(Eval("enddate")), "dd").ToString%>]</span><img src="http://img02.100allin.com/images2/fcl/02270434.gif" width="30" height="13" title="环球运费网推荐" /></td>
</tr>
<tr>
...
<div><a href="<%#IIf(Eval("userid")="122117","http://www.100allin.com/shop/jjb/","/company/"& key(eval("userid")) & "/")%>" target="_blank" style="color:#666666;"><img src="/pm/p/images/e2.gif" border="0" title="点击查看联系方式" /></a></div>
</td>
</tr>
</table>
</li>
...
<asp:PlaceHolder ID="PlaceHolder3_1" runat="server" Visible="false">
<ul>
<asp:Repeater ID="Rptfcladv_1" runat="server">
<ItemTemplate>
<li style="border:1px solid #D8D8D8;background:#F3F3F3;margin-top:3px;">
<table width="742" height="75" border="0" cellpadding="0" cellspacing="0">
<tr>
<td width="15" height="80" align="center"><table width="15" border="0" cellpadding="0" cellspacing="0" class="fcl_spbox">
<tr>
...
<td width="622" onmouseover="tt2_1('<%#Rptfcladv.Items.Count %>','pop_a_<%# eval("sid") %>_<%# eval("id") %>',event)" onmouseout="hidden(event)"><table width="622" height="80" border="0" cellpadding="0" cellspacing="0">
<tr>
<td colspan="2" id="pop_a_<%# eval("sid") %>_<%# eval("id") %>"><a href="/air/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><span style="color:#971817; font-weight:bold;"><%#GetFirstString(Eval("title").ToString, 24)%></a></span>
<span class="gray_2">[<%#Format(Eval("postdate"), "yy").ToString%>/<%#Format(Eval("postdate"), "MM").ToString%>/<%#Format(Eval("postdate"), "dd").ToString%> 至 <%#Format(CDate(Eval("enddate")), "yy").ToString%>/<%#Format(CDate(Eval("enddate")), "MM").ToString%>/<%#Format(CDate(Eval("enddate")), "dd").ToString%>]</span><img src="http://img02.100allin.com/images2/fcl/02270434.gif" width="30" height="13" title="环球运费网推荐" /></td>
</tr>
...
<td width="105" align="center">
<div><a href="<%#IIf(Eval("userid")="122117","http://www.100allin.com/shop/jjb/","/company/"& key(eval("userid")) & "/")%>" target="_blank" style="color:#666666;"><img src="/pm/p/images/p2.gif" border="0" title="点击查看联系方式" /></a></div>
</td>
</tr>
</table>
</li>
...
<input id="Hidden2_1" runat="server" style="width: 1px" type="hidden" />
<input id="Hiddennn2_1" runat="server" style="width: 1px" type="hidden" />
...
<td width="105" align="center">
<div><a href="<%#IIf(Eval("userid")="122117","http://www.100allin.com/shop/jjb/","/company/"& key(eval("userid")) & "/")%>" target="_blank" style="color:#666666;"><img src="/images2/fcl/dingc_r62.gif" border="0" title="点击查看联系方式" /></a></div>
</td>
</tr>
</table>
</li>
...
<input id="Hiddenmm1" runat="server" style="width: 1px" type="hidden" />	                  
</div>
</div>		
...
<asp:Literal ID="ltrBanner_1" runat="server"></asp:Literal>

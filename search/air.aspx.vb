...
Partial Class search_air
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For i As Integer = 0 To 14
            ...
            Else
                lblStartportHot.Text = lblStartportHot.Text & "<li><a href = ""/air/list-" & StartportHotArray(i).Split(",")(1) & "-" & dp & "-" & cr & "-" & l & "-0-0-----1.html"">" & StartportHotArray(i).Split(",")(0) & "</a></li>"
            End If
        Next
        ...
        Else
            lblStartportHot.Text = "<li class=""first""><a href = ""/air/list--" & dp & "-" & cr & "-" & l & "-0-0-----1.html"">全部</a></li>" & lblStartportHot.Text
        End If
        ...
        For i As Integer = 0 To 7
            ...
            Else
                If i = 0 Then
                    lblLineHot.Text = lblLineHot.Text & "<li class=""first""><a href = ""/air/list-" & sp & "-" & dp & "-" & cr & "-" & LineHotArray(i).Split(",")(1) & "-0-0-----1.html"">" & LineHotArray(i).Split(",")(0) & "</a></li>"
                Else
                    lblLineHot.Text = lblLineHot.Text & "<li><a href = ""/air/list-" & sp & "-" & dp & "-" & cr & "-" & LineHotArray(i).Split(",")(1) & "-0-0-----1.html"">" & LineHotArray(i).Split(",")(0) & "</a></li>"
                End If
        ...
        Dim lorder1 As String = "<li class=""first""><a href=""/air/list-" & sp & "-" & dp & "-" & cr & "-" & l & "-0-0-----1.html"">最新</a></li>"
        If order = 0 Then
            lorder1 = "<li class=""current first""><a href=""/air/list-" & sp & "-" & dp & "-" & cr & "-" & l & "-0-0-----1.html"">最新</a></li>"
        End If
    ...
    Sub LoadRecord(ByVal page As String)
        ...
        If cp = 1 Then
            s = s + "<span class=""disabled""><img src='/images/air/jt5.gif' width='9' height='9'  border=0 /></span> "
            s = s + "<span class=""disabled""><img src='/images/air/jt6.GIF' border=0  /></span> "
        ...
        Else
            s = s + "<a href=""" + base_url + "1" + end_url + """><span><img src='/images/air/jt5.gif' width='9' height='9'  border=0 /></span></a> "
            s = s + "<a href=""" + base_url + (cp - 1).ToString + end_url + """><span><img src='/images/air/jt6.GIF' border=0  /></span></a> "
        ...
        If cp = tp Then
            ...
            s = s + "<span class=""disabled""><img src='/images/air/jt7.gif' width='9' height='9' border=0 /></span> "
        Else
            s = s + "<a href=""" + base_url + (cp + 1).ToString + end_url + """><span>下一页</span></a> "
            s = s + "<a href=""" + base_url + tp.ToString + end_url + """><span><img src='/images/air/jt7.gif' width='9' height='9' border=0 /></span></a> "
        End If
        ...
        If (startport.ToLower = "shanghai" Or startport = "上海" Or startport.ToLower = "sha" Or startport.ToLower = "pvg") Then
            ltrBanner.Text = "<div class=""right_ad""><a href=""http://www.100allin.com/company/cmdWTUtyQlZFVjRleXZiMkVxOHpmQT09/"" target=""_blank""><img src=""http://img02.100allin.com/images2/banner/dz.gif"" width=""251""  border=""0"" /></a></div> <div class=""right_ad""><a href=""http://www.100allin.com/company/VVRwS29NK1V1ZGg4cUhrbXAxMi81QT09/"" target=""_blank""><img src=""http://img02.100allin.com/images2/banner/yc.gif"" width=""251""  border=""0"" /></a></div>"
        Else
        ...
        If (startport.ToLower = "beijing" Or startport = "北京" Or startport.ToLower = "bjs" Or startport.ToLower = "nay" Or startport.ToLower = "pek") Then
            ltrBanner.Text = "<div class=""right_ad""><a href=""http://www.100allin.com/company/Wk1vdUF0ZzBFeWlOVUlMTWV0TDNXUT09/"" target=""_blank""><img src=""http://img02.100allin.com/images2/banner/jky.gif"" width=""251""  border=""0"" /></a></div>"
        End If

...
Partial Class search_fcl_home
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        Response.Redirect("/fcl/list-" & txtStartport.Text & "-" & txtDestport.Text.ToUpper.Replace("-", "$") & "-" & txtCarrier.Text.ToUpper & "-" & txtLine.SelectedIndex.ToString & "-0-0-----1.html")
    End Sub
    ...
    Sub LoadBase()
        ...
        Dim sql As String
        sql = ""
        sql = sql + "SELECT top 15 id,startport,destport,title,hangxianmiaoshu,companyname,UserID,price20gp,price40gp,price40hq "
        sql = sql + "FROM V_最新_整箱运价 "
        ...
        sql = ""
        sql = sql + "SELECT fclcount FROM TB_PRICECOUNT "

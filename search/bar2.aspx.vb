...
Partial Class search_bar2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ImageButton14.Attributes.Add("onmouseover", "this.src='../images/search3_s.gif'")
        ImageButton14.Attributes.Add("onmouseout", "this.src='../images/search3.gif'")
        ImageButton14.Attributes.Add("onfocus", "this.src='../images/search3_s.gif'")
        ImageButton14.Attributes.Add("onblur", "this.src='../images/search3.gif'")

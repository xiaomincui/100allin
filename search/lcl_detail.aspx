...
<form>
    ...
    <div class="container breadcrumbs">
        <a href="/">首页</a><span class="sep">-</span><a href="/">拼箱海运价</a><span class="sep">-</span><span><asp:Literal ID="ltrTitleBC" runat="server"></asp:Literal></span>
    </div>

<asp:Panel ID="Panel2" runat="server"  Visible="false">
<div class="main_content"><!--中部开始-->
<div class="" style="background:url(/images/lcl/info_bg.gif) no-repeat left top;"><!--左边开始-->
<div style="clear:both;">
<table width="92%" border="0" align="center" cellpadding="0" cellspacing="1" style="background:url(/images/lcl/33.gif) no-repeat right 65px;">
<tr><td height="10" align="center"></td></tr>
<tr><td height="32" align="left" ><div class="blue" style=" font:14px '宋体'; line-height:48px; border-bottom:1px dashed #ccc;"><img src="/images2015/lcl/jt2.gif" />&nbsp;<strong>环球运费网提示</strong></div></td></tr>
<tr><td height="10" align="center" ></td></tr>
<tr><td height="10" align="center" ></td></tr>
<tr><td height="10" align="center" ></td></tr>								
...
<a href="/lcl/">http://www.100allin.com/lcl/</a></td></tr>
</table>
<br/><br/><br/><br/>
</div>
</div>
...
<div class="main_content"><!--中部开始-->
<div class="" style="background:url(/images2015/lcl/info_bg.gif) no-repeat left top;">
<div style="clear:both;">
<table width="92%" border="0" align="center" cellpadding="0" cellspacing="1" style="background:url(/images2015/lcl/33.gif) no-repeat right 65px;">
<tr><td height="10" align="center"></td></tr>
<tr><td height="32" align="left" ><div class="blue" style=" font:14px '宋体'; line-height:48px; border-bottom:1px dashed #ccc;"><img src="/images2015/lcl/jt2.gif" />&nbsp;<strong>环球运费网提示</strong></div></td></tr>
<tr><td height="10" align="center" ></td></tr>
<tr><td height="10" align="center" ></td></tr>
...
<br/><br/><br/><br/>
    ...
    <div class="container d-detail">
        <div class="detail-left">
            ...
            <div class="freight lcl">
                <dl>
                    <dt>KGS</dt>
                    <dd><asp:Literal ID="LabGP" runat="server"></asp:Literal></dd>
                </dl>
                <dl>
                    <dt>CBM</dt>
                    <dd><asp:Literal ID="LabGPV" runat="server"></asp:Literal></dd>
                </dl>
            </div>
        ...
        <div class="detail-right">
            ...
            <div class="u-head">
                <img id="imghead" src="/images2015/lcl/people.GIF" runat="server" />
            </div>
            <div class="u-name">
                ...
                <ItemTemplate>         
                    <li class="freight-row">
                            <div class="freight-bd">
                                <div class="title"><a href="/lcl/<%#key(Eval("yunjiaid"))%>_<%#Eval("id")%>.html"><%#Eval("startport1").ToString.ToUpper %> 至 <%#Eval("destport").ToString.ToUpper %></a><span><%#(Convert.ToDateTime(Eval("enddatex")) - DateAndTime.Now()).Days.ToString()%> 天内有效</span></div>
                                <div class="content">
                                    <div class="freight">
                                        <dl>
                                            <dt>KGS</dt>
                                    ...
                                    <div class="op">
                                        <div class="order"><a href="/lcl/<%#key(Eval("yunjiaid"))%>_<%#Eval("id")%>.html">查看</a> <a href="/lcl/list-<%#Eval("startport1")%>-<%#Eval("destport") %>--0-0-0-----1.html" target="_blank" class="more">更多</a></div>
                                    </div>
                                </div>
                            </div>
                    </li>

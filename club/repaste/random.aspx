<%@ Page Language="C#" AutoEventWireup="true" CodeFile="random.aspx.cs" Inherits="club_repaste_random" %>
...
<LI class="hover"><a href="random.aspx">今日热门</a></LI>
</UL>
</DIV>
<DIV class="main2box">
<ul>
...
<ItemTemplate>
<tr>
<td width="80" height="34" align="center" valign="top" ><div class="picSmall"><a href="/home/space.php?uid=<%#Eval("uhomeid2").ToString() %>"><img src="/uc/avatar.php?uid=<%#Eval("uhomeid2").ToString() %>&size=small&type=virtual" width="50" height="50" border="0"></a><br>
<a href="/home/space.php?uid=<%#Eval("uhomeid2").ToString() %>"><%#Eval("realname2").ToString() %></a></div></td>
...
<td width="438" background="images/zt_1.gif"><span class="gray"><%#Eval("ttime").ToString() %> 转帖</span></td>
...
<tr>
<td height="20">&nbsp;</td>
<td width="500" height="20"><div class="page2">
<%= pagecontrol_string%>
</div></td>
<td height="20">&nbsp;</td>
</tr>

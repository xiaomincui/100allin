...
public partial class club_repaste_random : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string u = "";
        u = GetRequest1.GetRequestCookies("user_id", "0");
        ...
        string sql = "";
        sql += "SELECT TOP 10 * ";
        sql += "FROM (SELECT * FROM V_REPASTE_INDEX) AS T WHERE rid NOT IN ";
        sql += "(SELECT TOP " + item.ToString() + " rid FROM V_REPASTE_INDEX ORDER BY rid DESC) ORDER BY rid DESC";
        ...
        sql = "SELECT rid as c FROM V_REPASTE_INDEX ";
        ds = cn.mdb_ds(sql, "repaste");

        string base_url = "random.aspx?p=";

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="other.aspx.cs" Inherits="club_repaste_other" %>
...
<DIV id=mainarea>
<div class="left_tit">
<div class="left_tit_text"><img src="images/icon28.gif"><strong><asp:Literal ID="Literal1" runat="server"></asp:Literal>的转帖</strong></div>

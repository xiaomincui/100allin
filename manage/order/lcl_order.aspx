      ...
      <tr>
        <td height="31" align="left"><table width="796" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td><strong><span id='fgp'><asp:Literal ID="ltrFreightGP" runat="server"></asp:Literal></span></strong></td>
            <td><strong><span id='fgpv'><asp:Literal ID="ltrFreightGPV" runat="server"></asp:Literal></span></strong></td>
            <td><strong><span id='fappend' style="display:none;"><asp:Literal ID="ltrFreightAppend" runat="server"></asp:Literal></span><asp:Literal ID="ltrFreightCarrier" runat="server"></asp:Literal></strong></td>
            <td>

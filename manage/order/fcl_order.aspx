      ...
      <tr>
        <td height="31" align="left"><table width="796" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td><strong><span id='f20gp'><asp:Literal ID="ltrFreight20" runat="server"></asp:Literal></span></strong></td>
            <td><strong><span id='f40gp'><asp:Literal ID="ltrFreight40" runat="server"></asp:Literal></span></strong></td>
            <td><strong><span id='f40hq'><asp:Literal ID="ltrFreight40h" runat="server"></asp:Literal></span></strong></td>
            <td><strong><span id='f45hq'><asp:Literal ID="ltrFreight45h" runat="server"></asp:Literal></span></strong></td>

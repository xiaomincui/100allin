...
<html>
	...
	var OxO8321=["dialogArguments","","Content","changed","returnValue"];var editor; function editor_oninitialized(Ox384){ editor=Ox384 ;var Oxb0=top[OxO8321[0x0]]||OxO8321[0x1]; editor[OxO8321[0x2]]=Oxb0 ; top[OxO8321[0x3]]=true ; top[OxO8321[0x4]]=null ;}  ; function do_finish(){if(editor!=null){ top[OxO8321[0x4]]=true ;} ; top.close() ;}  ; function do_cancel(){ top[OxO8321[0x4]]=null ; top.close() ;}  ;
	</script>

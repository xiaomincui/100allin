...
<html>
	...
	<body  style="margin:0px;border-width:0px;padding:4px;">
		...
		<script language="JavaScript">
			var OxO2ec4=["inp_target","sel_protocol","inp_src","inp_title","dialogArguments","href","value","title","target","returnValue"]; window.resizeTo(0x15e,0xd4) ;var inp_target=document.getElementById(OxO2ec4[0x0]);var sel_protocol=document.getElementById(OxO2ec4[0x1]);var inp_src=document.getElementById(OxO2ec4[0x2]);var inp_title=document.getElementById(OxO2ec4[0x3]);var obj=top[OxO2ec4[0x4]];if(obj){if(obj[OxO2ec4[0x5]]){ inp_src[OxO2ec4[0x6]]=obj[OxO2ec4[0x5]] ;} ;if(obj[OxO2ec4[0x7]]){ inp_title[OxO2ec4[0x6]]=obj[OxO2ec4[0x7]] ;} ;if(obj[OxO2ec4[0x8]]){ inp_target[OxO2ec4[0x6]]=obj[OxO2ec4[0x8]] ;} ;} ; function insert_link(){var arr= new Array(); arr[0x0]=inp_src[OxO2ec4[0x6]] ;if(inp_target[OxO2ec4[0x6]]){ arr[0x1]=inp_target[OxO2ec4[0x6]] ;} ;if(inp_title[OxO2ec4[0x6]]){ arr[0x2]=inp_title[OxO2ec4[0x6]] ;} ; top[OxO2ec4[0x9]]=arr ; top.close() ;}  ;
		</script>

...
<html>
	...
	<body  style="margin:0px;border-width:0px;padding:4px;">
		...
		<script language="JavaScript">
			var OxOf7d2=["availWidth","availHeight","inp_target","sel_protocol","inp_src","inp_title","dialogArguments","href","value","title","target","returnValue"]; window.resizeTo(0x15e,0xd4) ; window.moveTo((screen[OxOf7d2[0x0]]-0x15e)/0x2,(screen[OxOf7d2[0x1]]-0xd4)/0x2) ;var inp_target=document.getElementById(OxOf7d2[0x2]);var sel_protocol=document.getElementById(OxOf7d2[0x3]);var inp_src=document.getElementById(OxOf7d2[0x4]);var inp_title=document.getElementById(OxOf7d2[0x5]);var obj=top[OxOf7d2[0x6]];if(obj){if(obj[OxOf7d2[0x7]]){ inp_src[OxOf7d2[0x8]]=obj[OxOf7d2[0x7]] ;} ;if(obj[OxOf7d2[0x9]]){ inp_title[OxOf7d2[0x8]]=obj[OxOf7d2[0x9]] ;} ;if(obj[OxOf7d2[0xa]]){ inp_target[OxOf7d2[0x8]]=obj[OxOf7d2[0xa]] ;} ;} ; function insert_link(){var arr= new Array(); arr[0x0]=inp_src[OxOf7d2[0x8]] ;if(inp_target[OxOf7d2[0x8]]){ arr[0x1]=inp_target[OxOf7d2[0x8]] ;} ;if(inp_title[OxOf7d2[0x8]]){ arr[0x2]=inp_title[OxOf7d2[0x8]] ;} ; top[OxOf7d2[0xb]]=arr ; top.close() ;}  ;
		</script>

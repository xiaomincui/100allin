...
<HTML>
	<head>
		...
		<script>
		var OxO992d=["dialogArguments","keyboard_area","length","value"];var editor=top[OxO992d[0x0]]; function do_insert(){var Ox61f=document.getElementById(OxO992d[0x1]);if(Ox61f[OxO992d[0x3]][OxO992d[0x2]]>0x0){ editor.PasteHTML(Ox61f.value) ;} ;}  ; function do_cancel(){ top.close() ;}  ;
		</script>
	</HEAD>
		<body>

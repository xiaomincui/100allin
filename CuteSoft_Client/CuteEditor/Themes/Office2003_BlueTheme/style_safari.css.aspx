...
<%=editorid%> .CuteEditorDropDown { display: block; float: left; padding:0; margin:2px 1px 1px 1px; width:80px; vertical-align:middle;border: #9FBDDC 1px solid!important;}
...
<%=editorid%> .CuteEditorToolBarContainer {padding:3px 3px 1px 3px;height:1;overflow-y:visible;}
<%=editorid%> .CuteEditorFrameContainer {padding:1px 4px 1px 4px;}
<%=editorid%> .CuteEditorBottomBarContainer {padding:1px 3px 3px 3px;height:1;overflow-y:visible;}
<%=editorid%> .CuteEditorGroupMenu {display: inline; background-image: url(images/horizontal.background.gif); background-repeat: repeat-x; background-position: bottom; height:24px; vertical-align:middle;border-bottom : 1px solid  #4681BC;border-left : 1px solid  #4681BC;}

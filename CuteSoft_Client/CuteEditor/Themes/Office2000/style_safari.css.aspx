...
<%=editorid%> .CuteEditorDropDown { display: block; float: left; padding:0; margin:2px 1px 1px 1px; width:80px; vertical-align:middle;}
...
<%=editorid%> .CuteEditorToolBarContainer {padding:2px;height:1;overflow-y:visible;}

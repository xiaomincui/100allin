...
public partial class usercontrols_userblankbottom : System.Web.UI.UserControl
{
    public string isft;
    ...
    void PageRecord()
    {
        ...
        string browsetable = "TB_BrowseRecord";
        string[] k;
        k = new string[10];
        ...
        for (int i = 0; i < k.Length - 1; i++)
        {
            if (k[i] != null)
            {
                ...
                {
                    browsetable = "TB_BrowseRecord_Spider";
                }
        ...
        {
            string sql = "insert into " + browsetable + " (Userid,UserIP,Pageid,NowTime,Request,page,pagearea,agent) values (0,'" + address + "',1,Getdate(),'" + request + "','" + page + "','" + pagearea + "','" + agent + "')";
            cn.mdb_exe(sql);
        ...
        else
        {
            ...
            else
            {
                ...
                string sql = "insert into " + browsetable + " (Userid,UserIP,Pageid,NowTime,Request,page,pagearea,agent) values (" + this.Request.Cookies["user_id"].Value + ",'" + address + "',1,Getdate(),'" + request + "','" + page + "','" + pagearea + "','" + agent + "')";
                cn.mdb_exe(sql);
            }
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="loginerr.aspx.cs" Inherits="accounts_loginerr" EnableEventValidation="false"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <div class="container">
        ...
        <div class="login-box">
            ...
            <div class="login-subtitle">
                    <div>登录后可发布运价，并无限制查看运价联系方式</div>
                    <div class="login-error">用户名或密码输入有误，请重新输入</div>
            </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myprecustomer.aspx.cs" Inherits="admin_sales_myprecustomer" %>
			...
			<adminleft:adminleft id="adminleft1" runat="server" />												
		  	<div id="right">
				<div class="tt18 bd rightTitle">
					...
					<div class="text">我的客户管理</div>
				</div>
				<div class="tt14 bd rightSubTitle">
					<div class="text">我正在跟进的客户</div>
				</div>

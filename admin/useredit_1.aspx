<%@ Page Language="VB" AutoEventWireup="false" CodeFile="useredit_1.aspx.vb" Inherits="admin_useredit" %>
		  	...
		  	<div id="right">
				...
				<div class="rightArea txth22">
                    ...
                    <div style="padding:0px 0px 10px 0px; font-size:14px;">
                        ...
                        <a href="useremail.aspx?id=<%=Request.QueryString("id") %>" target="_blank">给TA发邮件</a></asp:PlaceHolder>
                  ...
                  <td>
                        ...
                        <textarea name="txtintroduction" type="text"  class="textbox1" id="txtintroduction" style="width:250px; height: 80px;" onfocus="showTip('tipintroductionNormal','tipintroductionTrue','tipintroductionFalse')"  onblur="checkIntroduction('txtintroduction','tipintroductionNormal','tipintroductionTrue','tipintroductionFalse',1)" runat="server" /><%--<input  />--%>
                            ...
                            <tr>
                              ...
                              <tr>
                                  <td><div align="right">置顶</div>
                                  </td>
                                  <td>
                                  </td>
                                  <td>
                                      航线：<asp:TextBox ID="txtLine" runat="server" Width="249px" ReadOnly="True"></asp:TextBox>
                                      港口：<asp:TextBox ID="txtDestport" runat="server" Width="249px" ReadOnly="True"></asp:TextBox>
                                  </td>
                              </tr>
                              <tr>
                                  <td>
                                  ...
                                  <td>
                                  船公司：<asp:TextBox ID="txtShiper" runat="server" Width="249px" ReadOnly="True"></asp:TextBox>
                                  </td>
                              </tr>
                              <tr>
                        ...
                        <fieldset style="border:1px solid #CCCCCC" >
	                      ...
	                      <div align="center"><br />
                              <asp:PlaceHolder ID="PlaceHolder2" runat="server"> <input name="Submit" type="button" class="InputBtn" value="保存信息" style="width:80px; height:30px; line-height:25px; font-size:12px;"  id="Button1" runat="server" />
	                        &nbsp;&nbsp;&nbsp;</asp:PlaceHolder>

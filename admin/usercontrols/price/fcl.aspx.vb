...
Partial Class search_fcl
    ...
    Sub LoadRecord(ByVal page As String)
        ...
        If dp = "" And cr = "" Then
            ...
            sql = sql & "AND tb_yunjia.yunjialeixing = 8 and tb_yunjia.userid = " & u & " "
        ...
        Else
            If dp = "" Then
                ...
                sql = sql & "AND V_CARRIER_PRICE.yunjialeixingx = 8 and V_CARRIER_PRICE.useridx = " & u & " "
            ...
            Else
                ...
                sql = sql & "AND tb_yunjiainfo.yunjialeixingx = 8 and tb_yunjiainfo.useridx = " & u & " "
        ...
        Dim base_url As String = "/admin/price/fcl.aspx?l=" & l & "&cr=" & cr & "&u=" & u & "&p="

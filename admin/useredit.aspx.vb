...
Partial Class admin_useredit
    ...
    Public Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If GetRequest1.GetRequestCookies("admin_group", "3") = 3 Then
            Response.Redirect("useredit_1.aspx?id=" & GetRequest1.GetRequestQueryString("id", "0"))
        End If
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        sql = sql & "Login2_Adventage_Startport_Adv = '" & ck.CheckInput(txtStartport.Text) & "', "
        sql = sql & "Login2_Adventage_shipper_Adv = '" & ck.CheckInput(txtShiper.Text) & "', "
        sql = sql & "Login3_Adventage_Line_Adv = '" & ck.CheckInput(txtLine2.Text) & "', "
        sql = sql & "Login3_Adventage_Destport_Adv = '" & ck.CheckInput(txtDestport2.Text) & "', "
        sql = sql & "Login3_Adventage_Startport_Adv = '" & ck.CheckInput(txtStartport2.Text) & "', "
        sql = sql & "Login3_Adventage_shipper_Adv = '" & ck.CheckInput(txtShiper2.Text) & "', "
        sql = sql & "star_adv = " & ck.CheckInput(ddlstar_adv.SelectedValue) & ", "
        Dim ifen As String = ""
    ...
    Sub GetUserInfo()
        ...
        txtStartport.Text = ds.Tables("user").Rows(0)("Login2_Adventage_Startport_Adv").ToString
        txtShiper.Text = ds.Tables("user").Rows(0)("Login2_Adventage_shipper_Adv").ToString
        txtLine2.Text = ds.Tables("user").Rows(0)("Login3_Adventage_Line_Adv").ToString
        txtDestport2.Text = ds.Tables("user").Rows(0)("Login3_Adventage_Destport_Adv").ToString
        txtStartport2.Text = ds.Tables("user").Rows(0)("Login3_Adventage_Startport_Adv").ToString
        txtShiper2.Text = ds.Tables("user").Rows(0)("Login3_Adventage_shipper_Adv").ToString
        ddlstar_adv.SelectedValue = ds.Tables("user").Rows(0)("star_adv").ToString

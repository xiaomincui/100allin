<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cargo.aspx.cs" Inherits="admin_userlist" %>
	                ...
	                <table border="0" cellspacing="0" cellpadding="0">
	                  <tr>
	                    ...
	                    <span style="color: #226077">
                                    <input id="txtenddate" runat="server" name="date1" type="text" style="width: 74px" /></span></td>
	                    <td style="width: 54px">
                            货盘类型</td>
                        ...
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <div class="c10" style=" width:260px;"><nobr><a href='../cargo/<%# Eval("id")%>.html' target=_blank><%# Eval("TITLE")%></a></nobr></div>
                                    </ItemTemplate>                                                
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <%# Convert.ToDateTime(Eval("postdate")).ToString("yyyy-MM-dd")%>
                                    </ItemTemplate>                                                
                                    <ItemStyle Width="70px" />
                                </asp:TemplateField>
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:CheckBox ID="CheckBox1" AutoPostBack="True" Checked='<%#   Convert.ToInt32(Eval("sign"))==1?true:false%>' runat="server" OnCheckedChanged="ckbtop_CheckedChanged" />
                                        <%--<a href="fcl_detail.aspx?id=<%# Eval("id") %>"><img src="/admin/images/edit.gif" border=0 /></a> --%>
                                    </ItemTemplate>                                                

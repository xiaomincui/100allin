<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lcllist.aspx.cs" Inherits="admin_userlist" %>
...
<form id="form1" runat="server">
    <div id="page">
	  ...
	  <IMG id=IMG1 height=21 src="../web_Admin/images/button.gif" width=34 align=absMiddle border=0></A>
                        ...
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <div class="c10"><nobr><a href="/lcl/<%# key(Eval("id").ToString()) %>_0.html" target="blank"><%# Eval("title")%></a></nobr></div>
                                    </ItemTemplate>                                                
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="Spelljilu.aspx?id=<%# Eval("id") %>"><img src="/admin/images/edit.gif" border=0 /></a> 
                                    </ItemTemplate>                                                
                    ...
                    <div class="buttons">
                        <input id="Button1" type="button" value="删除选定用户" onclick="delAll()" style="width:100px; height:30px" /><br/><br/>

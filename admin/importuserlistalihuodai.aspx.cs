...
public partial class admin_importuserlistalihuodai : System.Web.UI.Page
{
    ...
    public void LoadRecord(string page)
    {
        ...
        sql = "select top 10 ";
        sql = sql + "sum,UserID,UserName,RealName,CompanyName,CompanyType,Phone,MovePhone,Regtime,mcount ";
        sql = sql + "FROM (SELECT ";
        sql = sql + "sum(mark) as sum ,tb_user.UserID,UserName,RealName,CompanyName,CompanyType,Phone,MovePhone,Regtime,count(TB_Feedback.id) as mcount ";
        sql = sql + "FROM ";
        sql = sql + "tb_user,TB_Mark,TB_Feedback  ";
        sql = sql + "WHERE ";
        sql = sql + "TB_User.UserID*=TB_Mark.UserID and TB_User.UserID*=TB_Feedback.UserID and importtype = 1 AND importtime = '2009-03-24 20:50:00' ";
        ...
        sql = sql + " group by tb_user.UserID,UserName,RealName,CompanyName,CompanyType,Phone,MovePhone,Regtime ";
        ...
        sql = sql + "tb_user ";
        sql = sql + "WHERE ";
        sql = sql + "1=1 and importtype = 1 AND importtime = '2009-03-24 20:50:00' ";
        ...
        sql = sql + "ORDER BY tb_user.UserID DESC ";
        sql = sql + ") ";

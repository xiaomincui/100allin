<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fcl_detail.aspx.cs" Inherits="admin_userlist" MaintainScrollPositionOnPostback="true" %>
...
<form id="form1" runat="server">
        ...
        <tr>
         ...
         <td bgcolor="#F9F9F9" style="width: 263px">
             ...
             <input id="txtpostdate" runat="server" name="date1" type="text" style="width: 149px" />
                 ...
                 </A><asp:TextBox ID="TextBox13" runat="server" Width="95px" Visible="False"></asp:TextBox>
                 </span></td>
        </tr>
        ...
        <tr>
            ...
            <div id="Div1">
                ...
                <div id="head" runat="server">
                    ...
                    <table bgcolor="#D9D9D9" border="0" cellpadding="2" cellspacing="1" style="width: 761px;
                        border-collapse: collapse">
                            <tr>
                                <td bgcolor="#F9F9F9" style="vertical-align: middle; width: 118px; height: 25px;
                                    text-align: center">
                                    目的港</td>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="20GP" SortExpression="price20gp">
                ...
                <ItemTemplate>
                    <asp:Label ID="Label7" runat="server" Text='<%# Bind("price20gp") %>'></asp:Label>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="40GP" SortExpression="price40gp">
                ...
                <ItemTemplate>
                    <asp:Label ID="Label9" runat="server" Text='<%# Bind("price40gp") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle  Font-Bold="False" Font-Names="宋体" HorizontalAlign="Center" />
                <ItemStyle Width="65px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="40HQ" SortExpression="price40hq">
                ...
                <ItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Bind("price40hq") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle  Font-Bold="False" Font-Names="宋体" HorizontalAlign="Center" />
                <ItemStyle Width="65px" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="船公司" SortExpression="DepartureWkd">
                ...
                <ItemTemplate>
                    <asp:Label ID="Label23" runat="server" Text='<%# Bind("shipcompany") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle  Font-Bold="False" Font-Names="宋体" HorizontalAlign="Center" />
                <ItemStyle Width="65px" />
            </asp:TemplateField>
    ...
    <table cellspacing="0" rules="all" bordercolor="#FFFFFF" border="1" style="height:1px;width:761px;border-collapse:collapse;">
        ...
        <asp:TextBox ID="TextBox4" runat="server" Width="114px"></asp:TextBox></td>
            <td style="height: 26px;width: 65px;">
    <asp:TextBox ID="TextBox5" runat="server" Width="59px"></asp:TextBox></td>
            <td style="height: 26px;width: 65px;">
        <asp:TextBox ID="TextBox6" runat="server" Width="59px"></asp:TextBox></td>
            <td style="height: 26px;width: 65px;">
        <asp:TextBox ID="TextBox7" runat="server" Width="59px"></asp:TextBox></td>
            <td style="height: 26px;width: 65px;">
        <asp:TextBox ID="TextBox8" runat="server" Width="59px"></asp:TextBox></td>
            <td style="height: 26px;width: 65px;">
        <asp:TextBox ID="TextBox9" runat="server" Width="59px"></asp:TextBox></td>
            <td style=" height: 26px;width: 65px;">
        <asp:TextBox ID="TextBox10" runat="server" Width="59px"></asp:TextBox></td>
            <td style=" height: 26px;width: 65px;">
        <asp:TextBox ID="TextBox12" runat="server" Width="59px"></asp:TextBox></td>
            
            <td style="height: 26px; width: 85px;">
        <asp:TextBox ID="TextBox11" runat="server" Width="79px"></asp:TextBox></td>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DB_DataBase_newConnectionString2 %>"
        ...
        InsertCommand="INSERT INTO [TB_YunJiaInfo] ([YunJiaID], [DestPort], [DepartureWkd], [Distance], [memo], [price20gpAppend], [price20gp], [price20gpMark], [price40gp], [price40hq]) VALUES (@YunJiaID, @DestPort, @DepartureWkd, @Distance, @memo, @price20gpAppend, @price20gp, @price20gpMark, @price40gp, @price40hq, @shipcompany)"
        SelectCommand="SELECT [ID], [YunJiaID], [DestPort], [DepartureWkd], [Distance], [memo], [price20gpAppend], [price20gp], [price20gpMark], [price40gp], [price40hq], [shipcompany] FROM [TB_YunJiaInfo] WHERE ([YunJiaID] = @YunJiaID)"
        UpdateCommand="UPDATE [TB_YunJiaInfo] SET [YunJiaID] = @YunJiaID, [DestPort] = @DestPort, [DepartureWkd] = @DepartureWkd, [Distance] = @Distance, [memo] = @memo, [price20gpAppend] = @price20gpAppend, [price20gp] = @price20gp, [price20gpMark] = @price20gpMark, [price40gp] = @price40gp, [price40hq] = @price40hq, [shipcompany] = @shipcompany WHERE [ID] = @ID" 
        ProviderName="<%$ ConnectionStrings:DB_DataBase_newConnectionString2.ProviderName %>">
        <DeleteParameters>

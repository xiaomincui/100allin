<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pagecount.aspx.cs" Inherits="admin_pagecount" %>
...
//]]>
                ...
                <table>
                    <tr style="font-weight:bold;">
                        <td colspan="4">按PV统计：共 <asp:Label ID="Label1" runat="server" Text=""></asp:Label></td>
                    </tr>                
                    <tr style="font-weight:bold;">
                        <td width="40">排名</td><td>页面</td><td width="60" align=right>浏览次数</td><td></td>
                    </tr>
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                    <tr>
                        <td><%#this.Repeater1.Items.Count + 1%></td>
                        <td style="width:400px;WORD-BREAK: break-all;"><%#Eval("pa").ToString()%></td>
                        <td width="60" align=right><%#Eval("c").ToString()%></td>
                        <td><img src="images/search/bluedot.gif" width="<%#Eval("p").ToString()%>" height="10" />
                        </td>
                    </tr>
                        </ItemTemplate>
                    </asp:Repeater>  
...
<br />                
                <table>
                    <tr style="font-weight:bold;">
                        <td colspan="4">按IP统计：共 <asp:Label ID="Label2" runat="server" Text=""></asp:Label>    </td>
                    </tr>                
                    <tr style="font-weight:bold;">
                        <td width="40">排名</td><td>页面</td><td width="60" align=right>浏览次数</td><td></td>
                    </tr>

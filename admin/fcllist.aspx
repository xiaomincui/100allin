<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fcllist.aspx.cs" Inherits="admin_userlist" %>
...
<form id="form1" runat="server">
    <div id="page">
			...
			<adminleft:adminleft id="adminleft1" runat="server" />												
		  	<div id="right">
				<div class="tt18 bd rightTitle">
					...
					<div class="text">运价管理</div>
				</div>
				<div class="tt14 bd rightSubTitle">
					<div class="text">运价编辑</div>
				</div>	
	  ...
	  <IMG id=IMG1 height=21 src="../web_Admin/images/button.gif" width=34 align=absMiddle border=0></A>
                        ...
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <div class="c10"><nobr><a href="/fcl/<%# key(Eval("id").ToString()) %>_0.html" target="blank"><%# Eval("title")%></a></nobr></div>
                                    </ItemTemplate>                                                
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="jilu.aspx?id=<%# Eval("id") %>"><img src="/admin/images/edit.gif" border=0 /></a> 
                                    </ItemTemplate>                                                
                    ...
                    <div class="buttons">
                        <input id="Button1" type="button" value="删除选定运价" onclick="delAll()" style="width:100px; height:30px" /><br/><br/>

...
public partial class admin_importuserlist : System.Web.UI.Page
{
    ...
    public void LoadRecord(string page)
    {
        ...
        sql = sql + "WHERE ";
        sql = sql + "TB_User.UserID*=TB_Mark.UserID and TB_User.UserID*=TB_Feedback.UserID and importtype = 1 ";

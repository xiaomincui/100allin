<%@ Page Language="C#" AutoEventWireup="true" CodeFile="freightlist.aspx.cs" Inherits="admin_freightlist" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <div class="c10"><nobr><a href="/fcl/<%# key(Eval("id").ToString()) %>_0.html"><%# Eval("title")%></a></nobr></div>
                                    </ItemTemplate>                                                
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <div class="c12"><nobr><%# Eval("realname")%></nobr></div>

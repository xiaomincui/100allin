<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="admin_productsapply_list" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <input id="id" type="checkbox" value="<%# Eval("pid") %>" onclick="checkToList(this.form)" />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <%# Eval("Realname")%> | <%# Eval("gender")%> | <%# Eval("rank")%>
                                    </ItemTemplate>                                                
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        电话:<%# Eval("phone")%><br/>
                                        手机:<%# Eval("movephone")%><br/>
                                        邮件:<%# Eval("useremail")%><br/>
                                    </ItemTemplate>                                                
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        套餐:<%# Eval("pro1")%> 投递:<%# Eval("pro2")%> <br/>
                                        直达:<%# Eval("pro3")%> 商铺:<%# Eval("pro4")%><br/>
                                        滚动:<%# Eval("pro5")%> 展示:<%# Eval("pro6")%> <br/>                                      
                                    </ItemTemplate>                                                
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="javascript:delConfirm('<%# Eval("pid") %>')"><img src="/admin/images/del.gif" border=0 /></a>
                                    </ItemTemplate>                                                

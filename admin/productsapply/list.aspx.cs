...
public partial class admin_productsapply_list : System.Web.UI.Page
{
    ...
    public void LoadRecord(string page)
    {
        ...
        sql = sql + "* ";
        sql = sql + "FROM ";
        sql = sql + "TB_PRODUCTS_APPLY ";
        sql = sql + "WHERE pid NOT IN ";
        sql = sql + "(SELECT TOP " + item.ToString() + " pid ";
        sql = sql + "FROM ";
        sql = sql + "TB_PRODUCTS_APPLY ";
    ...
    public void LoadTotalCount()
    {
        ...
        sql = "SELECT COUNT(*) FROM TB_PRODUCTS_APPLY ";
    ...
    public void delete()
    {
        ...
        if (id != "")
        {
            ...
            DataSet ds = new DataSet();
            string sql = "";
            sql = sql + "delete from TB_PRODUCTS_APPLY where pid in (" + id + ")";
            cn.mdb_exe(sql);

...
public partial class admin_userlist : System.Web.UI.Page
{
    ...
    public void LoadRecord(string page)
    {
        ...
        sql = sql + "WHERE ";
        sql = sql + "TB_User.UserID=TB_YunJia.UserID and TB_YunJia.yunjialeixing=8 ";
    ...
    public void delete()
    {
	    ...
	    sql = "";
            ...
            cn.mdb_exe(sql);
	    sql = "";
            sql = sql + "delete from TB_Yunjia_Effective_8 where YunJiaID in (" + id + ")";
            cn.mdb_exe(sql);
	    sql = "";
            sql = sql + "delete from TB_YunjiaInfo_Effective_8 where YunJiaID in (" + id + ")";
            cn.mdb_exe(sql);
    ...
    public void pass()
    {
        ...
        if (id != "")
        {
            ...
            cn.mdb_exe(sql);
            sql = "";
            sql = sql + "update TB_Yunjia_Effective_8 set ifpass = 1 where YunJiaID in (" + id + ")";
            cn.mdb_exe(sql);

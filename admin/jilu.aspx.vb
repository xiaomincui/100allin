...
Partial Class admin_jilu
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Dim ds3 As DataSet
            Dim conn As New data_conn3
            ds3 = conn.mdb_ds("select * from TB_User where UserID=" + ds.Tables(0).Rows(0)("UserID").ToString, "table")
            LoadScript(ds3.Tables("table").Rows(0)("star_allin").ToString)
        End If
    End Sub
    ...
    Protected Sub Button11_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button11.Click
        ...
        Else
            ...
            Dim ds As Data.DataSet = cn.mdb_ds("select * from TB_User where UserID=" + dsuser.Tables(0).Rows(0)("UserID").ToString, "user")
            ...
            If dsStartPort.Tables("StartPort").Rows.Count > 0 Then
                ...
                tp.SetTopNew(check.CheckNumber(Request("id")), check.CheckInput(txtTitle.Text.Replace("'", "''")), Date.Now, 8, check.CheckInput(DropDownList1.Text.Replace("'", "''")), check.CheckInput(StartPort_en.Replace("'", "''")), check.CheckNumber(dsuser.Tables(0).Rows(0)("UserID").ToString))
            ...
            Me.Response.Redirect("fcllist.aspx")
        End If

...
<form id="form1" runat="server">
    ...
    (Eval("CompanyType").ToString() == "10") ? "报关" :  ""                                  
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <div class="c9"><nobr><a href="recommend/RecommendAdmin.aspx?RecommendUserID=<%# Eval("UserID") %>"><%# (Eval("sum").ToString() != "") ? Eval("sum") : "无"%></a></nobr></div>
                               ...
                               <asp:TemplateField>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="usermemo.aspx?id=<%# Eval("UserID") %>"><img src="/admin/images/<%# ( Convert.ToInt32(Eval("mcount")) > 0) ? "feedback1" : "feedback"%>.gif" border=0 /></a> 
                                    </ItemTemplate>                                                
                                    <ItemStyle Width="30px" HorizontalAlign="Center" />
                                </asp:TemplateField>                                                                                                                                                                                      
                               <asp:TemplateField>
                    ...
                    <div class="buttons">
                        ...
                        <input id="Button1" type="button" value="删除选定用户" onclick="delAll()" style="width:100px; height:30px" /><br/><br/></asp:PlaceHolder>
                        <input id="Button3" type="button" value="通过选定用户" onclick="passAll()" style="width:100px; height:30px" />

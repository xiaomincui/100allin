<%@ Page Language="C#" AutoEventWireup="true" CodeFile="titleIMG2.aspx.cs" Inherits="admin_userlist"  ValidateRequest="false" %>
    ...
    <div id="page">
		<div id="center">
          ...
          <tr>
            ...
            <td width="44%" align="left">&nbsp;<img  src="/images/index/pic_2.gif" onerror="this.style.display = 'none'" width="60" height="60" /></td>
          <tr>

    ...
    protected void  Page_Load(object sender, EventArgs e)
{
        ...
        if (! Page.IsPostBack)
        {
            ...
            txtmemo.Text = memo;
            if (ds.Tables[0].Rows[0]["UserID2"].ToString() == "")
            {
    ...
    protected void  Button1_Click1(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //this.Response.Write("update TB_YunJia set title='" + ck.CheckInput(TextBox1.Text.Replace("'", "''")) + "',enddate='" + ck.CheckInput(txtenddate.Value.Replace("'", "''")) + "',StartPort='" + ck.CheckInput(txtStartPost.Text.Replace("'", "''")) + "',hangxianmiaoshu='" + ck.CheckInput(ddlhangxianmiaoshu.Text.Replace("'", "''")) + "',memo='" + meno.Replace("'", "''") + "',PostDate='" + time.Replace("'", "''") + "',hits=" + this.txthit.Text + ",UserID2=" + this.Hidden1.Value + " where id=" + ck.CheckNumber(Request["id"]));
    ...
    public void updatePostDate()
    {
        ...
        myCommand.ExecuteNonQuery();
        conn.Close();
        //txtpostdate.Value = DateTime.Now.ToString();
    }

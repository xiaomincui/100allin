<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Portinputrelasion.aspx.cs" Inherits="admin_userlist"  ValidateRequest="false" %>
                        ...
                        >
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <%# (Eval("PortLocation").ToString() == "0") ? "启运港" : "目的港"%>
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="javascript:delConfirm('<%# Eval("RID") %>')"><img src="/admin/images/del.gif" border=0 /></a>
                                    </ItemTemplate>                                                

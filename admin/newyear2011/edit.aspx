<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="admin_newyear2011_edit" %>
		  	...
		  	<div id="right">
				...
				<div class="tt14 bd rightSubTitle">
		  	    ...
		  	    <div style="border:1px solid #D9D9D9;background:#F0F0F0;padding:  6px 5px 5px 10px;margin:0px 0px 7px 0px;">
		  	          <table>
		  	            <tr>
		  	                <td><strong>公司名</strong></td>
		  	                <td><div style=" padding:0px 0px 0px 20px"><asp:TextBox ID="txt_companyname" runat="server"></asp:TextBox></div></td>
		  	            </tr>
		  	            <tr>
		  	                <td><strong>祝福语</strong></td>
		  	                <td><div style=" padding:0px 0px 0px 20px"><asp:TextBox ID="txt_zhufu" runat="server" TextMode="MultiLine" Width="600" Height="300"></asp:TextBox></div></td>
		  	            </tr>			  	            		  	            	  	            		  	            	  	          
		  	          </table>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="admin_newyear2011_list" %>
			...
			<adminleft:adminleft id="adminleft1" runat="server" />												
		  	<div id="right">
				<div class="tt18 bd rightTitle">
					...
					<div class="text">2011新年祝福</div>
				</div>
				<div class="tt14 bd rightSubTitle">
					<div class="text">祝福列表</div>
				</div>
                        ...
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <input id="id" type="checkbox" value="<%# Eval("nid") %>" onclick="checkToList(this.form)" />
                                    </ItemTemplate>
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <%# Convert.ToDateTime(Eval("ntime")).ToString("yyyy-MM-dd")%><BR/>
                                        <%# Convert.ToDateTime(Eval("ntime")).ToString("HH:mm:ss")%>
                                    </ItemTemplate>                                                
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="edit.aspx?id=<%# Eval("nid") %>"><img src="/admin/images/edit.gif" border=0 /></a> 
                                    </ItemTemplate>                                                
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="javascript:delConfirm('<%# Eval("nid") %>')"><img src="/admin/images/del.gif" border=0 /></a>
                                    </ItemTemplate>                                                
                                    <ItemStyle Width="30px" HorizontalAlign="Center" />
                                </asp:TemplateField>                                    
                            </Columns>                        

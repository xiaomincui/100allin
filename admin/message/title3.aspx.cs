...
public partial class admin_userlist : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            DataSet ds = cn.mdb_ds("SELECT * FROM TB_TOPBBS WHERE tid = 3", "bbs");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        string sql = "update TB_TOPBBS set title='" + txttitle.Value + "',alttxt='" + txttitle.Value + "',linkurl='" + txtimagelink.Value + "',indextxt='" + txtindex.Value + "' where tid=3";
        ...
        {
            string filepath = Server.MapPath("../../images/bbs/") + "/showpic1.jpg";

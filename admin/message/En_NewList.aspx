<%@ Page Language="C#" AutoEventWireup="true" CodeFile="En_NewList.aspx.cs" Inherits="admin_userlist" %>
                    ...
                    <div class="listTable">
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound" Width="780px">
                            ...
                            <asp:TemplateField >
                                ...
                                <nobr><a href='BBSMessage.aspx?id=<%# Eval("id")%>&page=1' target="_blank">
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="En_News.aspx?id=<%# Eval("id") %>"><img src="/admin/images/edit.gif" border=0 /></a> 
                                    </ItemTemplate>                                                

...
public partial class admin_message_Setrate : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = "update TB_NEWRATE set rate = '" + content1.Value + "' ,rdate = getdate(), ratesimple = '" + TextBox1.Text + "|" + TextBox2.Text + "|" + TextBox3.Text + "|" + TextBox4.Text + "'";
    ...
    protected void LoadRate()
    {
        ...
        {
            content1.Value = ds.Tables["rate"].Rows[0][0].ToString();
        }

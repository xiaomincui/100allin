<%@ Page Language="C#" AutoEventWireup="true" CodeFile="title1.aspx.cs" Inherits="admin_userlist"  ValidateRequest="false" %>
    ...
    <div id="page">
		<div id="center">
          ...
          <tr>
            ...
            <td colspan="2" align="left"><input name="Username22" type="text" id="txttitle" size="30" runat="server" maxlength="17" /></td>
          </tr>
          <tr>
            <td height="38" align="right" bgcolor="#FAFAFA"><span class="red">*</span>&nbsp;正文</td>
            <td colspan="2" align="left" bgcolor="#FAFAFA">
                <asp:TextBox ID="txttext" runat="server" Height="65px" Width="209px" TextMode="MultiLine"></asp:TextBox></td>
          </tr>
              <tr>

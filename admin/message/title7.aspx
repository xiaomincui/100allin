<%@ Page Language="C#" AutoEventWireup="true" CodeFile="title7.aspx.cs" Inherits="admin_userlist"  ValidateRequest="false" %>
...
<form id="form1" runat="server">
    <div id="page">
		<div id="center">
          ...
          <tr>
            <td width="30%" height="38" align="right"><span class="red">*</span>&nbsp;alt</td>
            <td colspan="2" align="left"><input name="Username22" type="text" id="txttitle" size="30" runat="server" maxlength="20" /></td>
          </tr>
          <tr>
            ...
            <td colspan="2" align="left" bgcolor="#FAFAFA">
              ...
              <tr>
                  ...
                  <td align="left"  colspan="2">
                      ...
                      <img src="../../images/bbs/pic2.jpg" width="299px" height="242px" /></td>
              </tr>
          <tr>

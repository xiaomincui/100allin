<%@ Page Language="C#" AutoEventWireup="true" CodeFile="title8.aspx.cs" Inherits="admin_userlist"  ValidateRequest="false" %>
    ...
    <div id="page">
		<div id="center">
          ...
          <tr>
            ...
            <td colspan="2" align="left"><input name="Username22" type="text" id="txttitle" size="30" runat="server" maxlength="8" /></td>
          </tr>
          <tr>
            ...
            <td colspan="2" align="left" bgcolor="#FAFAFA">
              ...
              <tr>
                  ...
                  <td align="left"  colspan="2">
                      ...
                      <img src="../../images/bbs/talk_pic2.gif" width="97px" height="97px" /></td>
              </tr>
          <tr>

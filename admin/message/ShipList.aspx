<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipList.aspx.cs" Inherits="admin_userlist" %>
                    ...
                    <div class="listTable">
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound" Width="780px">
                            ...
                            <asp:TemplateField >
                                ...
                                <asp:TemplateField >
                                <ItemTemplate>
                                <div class="c6" style=" width:120px;padding-left:20px">
                                <nobr><a href='../../ship/ship-<%# Eval("id")%>.html' target="_blank">
                                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("name_en_s") %>'></asp:Label></a></nobr>
                                </div>
                                </ItemTemplate>
                                
                                <ItemStyle Width="120px" />
                                <HeaderTemplate>
                                    <div style=" padding-left:20px">英文缩写</div>
                                </HeaderTemplate>
                            ...
                            <asp:TemplateField >
                                ...
                                <div class="c6" style=" width:120px;padding-left:20px">
                                <nobr><a href='../../ship/ship-<%# Eval("id")%>.html' target="_blank">
                                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("name_en") %>'></asp:Label></a></nobr>
                                </div>
                                </ItemTemplate>
                                
                                <ItemStyle Width="120px" />
                                <HeaderTemplate>
                                    <div style=" padding-left:20px">英文全名</div>
                                </HeaderTemplate>
                            ...
                            <asp:TemplateField >
                                ...
                                <div class="c6" style=" width:120px;padding-left:20px">
                                <nobr><a href='../../ship/ship-<%# Eval("id")%>.html' target="_blank">
                                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("name_cn_s") %>'></asp:Label></a></nobr>
                                </div>
                                </ItemTemplate>
                                
                                <ItemStyle Width="120px" />
                                <HeaderTemplate>
                                    <div style=" padding-left:20px">中文缩写</div>
                                </HeaderTemplate>
                            ...
                            <asp:TemplateField >
                                ...
                                <div class="c6" style=" width:120px;padding-left:20px">
                                <nobr><a href='../../ship/ship-<%# Eval("id")%>.html' target="_blank">
                                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("name_cn") %>'></asp:Label></a></nobr>
                                </div>
                                </ItemTemplate>
                                
                                <ItemStyle Width="120px" />
                                <HeaderTemplate>
                                    <div style=" padding-left:20px">中文全名</div>
                                </HeaderTemplate>
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="Ship.aspx?id=<%# Eval("id") %>"><img src="/admin/images/edit.gif" border=0 /></a> 
                                    </ItemTemplate>                                                

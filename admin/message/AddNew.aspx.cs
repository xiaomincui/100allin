...
public partial class admin_message_Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = "insert into TB_BBS (title,UserID,Data,PostDate,hits,UpdateDate,types) values ('" + txtTitle.Text + "',41,'" + ck.CheckRecord(content1.Value) + "','" + BasicDatePicker1_TextBox.Value + "',0,getdate()," + DropDownList1.SelectedValue.ToString() + ")";

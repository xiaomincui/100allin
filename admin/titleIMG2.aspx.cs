...
public partial class admin_userlist : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            DataSet ds = cn.mdb_ds("select * from TB_IMGIndex where id=2", "index");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        string sql = "update TB_IMGIndex set txtlink='" + txtimagelink.Value + "' where id=2";
        ...
        {
            string filepath = Server.MapPath("../images/index/") + "/pic_2.gif";

...
public partial class admin_importuserlistalie : System.Web.UI.Page
{
    ...
    public void LoadRecord(string page)
    {
        ...
        sql = sql + "WHERE ";
        sql = sql + "TB_User.UserID*=TB_Mark.UserID and TB_User.UserID*=TB_Feedback.UserID and importtype = 1 AND importtime = '2008-03-13 00:00:00' ";
        ...
        sql = sql + "tb_user ";
        sql = sql + "WHERE ";
        sql = sql + "1=1 and importtype = 1 AND importtime = '2008-03-13 00:00:00' ";

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="searchwordscount.aspx.cs" Inherits="admin_searchwordscount" %>
...
//]]>
                ...
                <table border="0" cellpadding="3" cellspacing="0">
                    <tr style="font-weight:bold;">
                        <td colspan="5">按启运港排列：</td>
                    </tr>
                    <tr style="font-weight:bold;">
                        <td width="40">排名</td><td width="120">关键字</td><td width="60" align=right>有效运价</td><td width="60" align=right>搜索次数</td><td></td>
                    </tr>
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                    <tr>
                        <td><%#this.Repeater1.Items.Count + 1%></td>
                        <td><%#Eval("N").ToString()%></td>
                        <td align=right><%#Eval("v").ToString()%></td>

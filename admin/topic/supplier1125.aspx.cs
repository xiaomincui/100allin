...
public partial class admin_topic_supplier1125 : System.Web.UI.Page
{
    ...
    public void LoadRecord(string page)
    {
        ...
        sql = "select top 10 ";
        sql = sql + "UserID,UserName,RealName,CompanyName,CompanyType,Phone,MovePhone,Regtime,importer,sid ";
        sql = sql + "FROM (SELECT ";
        sql = sql + "V_TOPIC_SUPPLIER_USERLIST.UserID,V_TOPIC_SUPPLIER_USERLIST.importer,UserName,RealName,CompanyName,CompanyType,Phone,MovePhone,Regtime,sid ";
        sql = sql + "FROM ";
        sql = sql + "V_TOPIC_SUPPLIER_USERLIST  ";
        sql = sql + "WHERE ";
        sql = sql + "1=1 ";
        sql = sql + ") AS T ";
        ...
        sql = sql + "ORDER BY V_TOPIC_SUPPLIER_USERLIST.sid DESC ";
        sql = sql + ") ";
    ...
    public void delete()
    {
        ...
        if (id != "")
        {
            ...
            DataSet ds = new DataSet();
            string sql = "";
            sql = sql + "delete from TB_TOPIC_SUPPLIER where sid in (" + id + ")";
            cn.mdb_exe(sql);

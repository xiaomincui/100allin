<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userlisthot.aspx.cs" Inherits="admin_userlisthot" %>
			...
			<adminleft:adminleft id="adminleft1" runat="server" />												
		  	<div id="right">
				...
				<div class="tt14 bd rightSubTitle">
					<div class="text">用户编辑<asp:Label ID="Label1" runat="server" Text="（自发整箱运价排序）"></asp:Label></div>
				</div>
				<div class="tt12" style="padding:0px 0px 10px 0px;">
				    <a href="userlisthot.aspx?type=1">自发整箱运价排序</a>
				    <a href="userlisthot.aspx?type=2">代发整箱运价排序</a>
				    <a href="userlisthot.aspx?type=3">自发拼箱运价排序</a>
				    <a href="userlisthot.aspx?type=4">代发拼箱运价排序</a>		
				    <a href="userlisthot.aspx?type=5">自发空运运价排序</a>
				    <a href="userlisthot.aspx?type=6">代发空运运价排序</a>
				    <a href="userlisthot.aspx?type=7">有备注客户</a>			
				    <a href="userlist.aspx">回到用户列表</a>
				</div>				
	                ...
	                <table border="0" cellspacing="0" cellpadding="0" height="30px">
	                 ...
	                 <table border="0" cellspacing="0" cellpadding="0" height="30px">
	                  <tr>
	                    ...
	                    <td style="width: 60px">
                            公司名称</td>
	                    <td width="161"><asp:TextBox ID="txtDestport" runat="server" CssClass="t3"></asp:TextBox></td>
	                    <td style="width: 20px"> </td>
	                  </tr>
	                 </table>	                 
                        ...
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <input id="id" type="checkbox" value="<%# Eval("UserID") %>" onclick="checkToList(this.form)" />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <%# (Eval("CompanyType").ToString() == "2") ? "<img src='/admin/images/type2.gif'/>" : ((Eval("CompanyType").ToString() == "1") ? "<img src='/admin/images/type1.gif'/>" : "<img src='/admin/images/type0.gif'/>")%>
                                    </ItemTemplate>                                                
                               ...
                               <asp:TemplateField>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="usermemo.aspx?id=<%# Eval("UserID") %>"><img src="/admin/images/<%# ( Convert.ToInt32(Eval("C")) > 0) ? "feedback1" : "feedback"%>.gif" border=0 /></a> 
                                    </ItemTemplate>                                                
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="javascript:delConfirm('<%# Eval("UserID") %>')"><img src="/admin/images/del.gif" border=0 /></a>
                                    </ItemTemplate>                                                
                                    <ItemStyle Width="30px" HorizontalAlign="Center" />
                                </asp:TemplateField>                                  
                            </Columns>                        

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionAnswer.aspx.cs" Inherits="admin_userlist" %>
                    ...
                    <div class="listTable">
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound" Width="780px">
                            ...
                            <asp:TemplateField >
                                ...
                                <nobr>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("id") %>'></asp:Label></nobr>
                                </div>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="最佳">
                                <ItemTemplate>
                                    <asp:Button ID="Button3" runat="server" Text="最佳" OnClick="Button3_Click" Enabled="" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fcl.aspx.vb" Inherits="search_fcl" EnableEventValidation="false" ValidateRequest="false" EnableViewState="false"%>
...
<usertop100414:usertop100414 ID="usertop100414_1" runat="server" />
...
<td width="37%" class="blue_2"><%#GetFirstString(Eval("startport").ToString, 6)%></td>
<td width="37%" class="blue_2"><%#GetFirstString(Eval("destport").ToString, 6)%></td>
</tr>
</table></td>
...
<tr>
<td height="24" align="center" bordercolor="0"></td>
</tr>
<tr>
<td height="24" align="center" bordercolor="0"></td>
</tr>

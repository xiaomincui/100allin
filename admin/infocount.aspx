<%@ Page Language="C#" AutoEventWireup="true" CodeFile="infocount.aspx.cs" Inherits="admin_infocount" %>
...
//]]>
                ...
                <table>
                    <tr style="font-weight:bold;">
                        <td width="40">序号</td><td width="100">页面</td><td  align=right>页面发布数量</td><td></td>
                    </tr>
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                    <tr>
                        <td><%#this.Repeater1.Items.Count + 1%></td>
                        <td><%#Eval("t").ToString()%></td>

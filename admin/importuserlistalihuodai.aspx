<%@ Page Language="C#" AutoEventWireup="true" CodeFile="importuserlistalihuodai.aspx.cs" Inherits="admin_importuserlistalihuodai" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
					<img src="/admin/images/type<%# Eval("CompanyType") %>.gif"    />

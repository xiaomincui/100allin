<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bbsadminedit.aspx.cs" Inherits="bbs_post" validateRequest=false %>
...
<head id="Head1" runat="server">
    ...
    function fill(id)
    {
        ...
        //alert(document.getElementById("title"+id).outerText);
        document.getElementById("Text1").value=document.getElementById("title"+id).outerText;
...
<form id="form2" runat="server">
 ...
 <%-- <tr>
  ...
  <tr>
    <td height="28">标题</td>
    <td><input name="Text1" type="text" size="40" id="Text1" runat="server" />
      </td>
    </tr>
  <tr>
    <td height="28">内容</td>
                                ...
                                <td colspan="2">
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <div class="c6" style="width: 170px; overflow: hidden; text-overflow: ellipsis; padding-left: 20px">
                                                        <span id='title<%# Eval("id") %>'><%# Eval("title") %></span>
                                    <%--<asp:Label ID="title" runat="server" Text='<%# Eval("title") %>'></asp:Label>--%>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <div class="c6" style="width: 170px; overflow: hidden; text-overflow: ellipsis; padding-left: 20px">
                                                        <span id='Data<%# Eval("id") %>'><%# Eval("Data") %></span>

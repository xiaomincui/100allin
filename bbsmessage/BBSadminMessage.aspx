    ...
    <div id="page">
			...
			<bbsadminleft:bbsadminleft id="bbsadminleft1" runat="server" />												
		  	<div id="right">
				...
				<div class="rightArea txth22">
                    ...
                    <div class="listTable">
                    <table cellspacing="0" cellpadding="3" rules="rows" bordercolor ="#D9D9D9" border="1" id="Table1" style="border-width:1px;border-style:Solid;width:780px;border-collapse:collapse;">
		<tr style="background-color:#F0F0F0;">
			<th scope="col">                                   
                                ...
                                </th><th scope="col">发帖人</th><th scope="col">
                                        编辑
                                    </th>
		</tr>
		...
		<tr onmouseover="this.style.backgroundColor='#F4F7FB';" onmouseout="this.style.backgroundColor='#ffffff';">
			<td style="width:0px;">
                                ...
                                <nobr>
                                    <span id="GridView1_ctl02_Label2"> <asp:Literal ID="Literal3" runat="server"></asp:Literal></span></nobr>
                                </div>
                                </td><td style="width:440px;">
                                <div class="c8" style=" padding-left:20px">
                                
                                    <span id="Span1"> <asp:Literal ID="Literal2" runat="server"></asp:Literal></span>
                                </div>
                                </td><td>
                                    
                                    <div class="c7"><nobr><span id="GridView1_ctl02_Label3"> <asp:Literal ID="Literal4" runat="server"></asp:Literal></span></nobr></div>
                                    <div class="c7"><nobr><span id="GridView1_ctl02_Label5"> <asp:Literal ID="Literal5" runat="server"></asp:Literal></span></nobr></div>
                        ...
                        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" BorderStyle="Solid" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound" Width="780px">
                            ...
                            <asp:TemplateField HeaderText="发帖人">
                               ...
                               <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="bbsadmineditreply.aspx?id=<%# Eval("id") %>"><img src="/admin/images/edit.gif" border=0 /></a> 
                                    </ItemTemplate>                                                
...
<asp:Button ID="Button3" runat="server" Text="返回列表"　style="width:100px; height:30px" OnClick="Button3_Click" />
                    </div>                  
			    </div>			
			</div>			
		  </div>

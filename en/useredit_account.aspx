<%@ Page Language="C#" AutoEventWireup="true" CodeFile="useredit_account.aspx.cs" Inherits="en_login_1" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>·</strong> <strong>View and post sea freight, air freight information</strong><br />
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>·</strong> <strong>Promote your services and products</strong></div>--%>
		  ...
		  <div class="ds">
            <h2>Account information<span style="color:Red"><asp:Literal ID="Literal1" runat="server"></asp:Literal></span></h2>

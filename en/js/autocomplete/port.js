...
var t1 = "txtStartport"; /*启运港*/
var t2 = "txtDestport";/*目的港*/
var loadimg = "/js/autocomplete/loading.gif";/*loading图片路径*/
var url = "/js/autocomplete/PostBack/port.aspx";
var currentIndex = -1;
/**
 * 动态创建div，并弹出
 * @param objid 对象id
    ...
    {     
            ...
            {       
                ...
                for (var i = 0; i < txt.length-1; i++) 
                {
                    ...
                    if(objid == t2)
                    prot_str +="<a href=\"#\" onclick=\"document.getElementById('"+objid+"').value='"+cn+"';hidediv('"+objid+"');\" tittle=\""+txt[i].Country+"\" id=\""+cn+"\"><span>"+ch+"("+txt[i].CountryCH+")</span>"+cn+"</a>";
                }
                var html_str ="";

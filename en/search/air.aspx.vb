...
Partial Class en_search_lcl
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'StartportHotArray(13) = "南京,nanjing'"
        'StartportHotArray(14) = "南宁,nanning"
        ...
        'Literal1.Text = "<title>" & seo_sp & seo_dp & "国际空运" & seo_l & "权威发布最新最全的" & seo_sp & seo_dp & "空运价格" & seo_l & "," & seo_sp & seo_dp & "空运代理" & seo_l & "报价等信息,环球运费网" & "</title>"
        'Literal2.Text = "<meta name=""keywords"" content=""" & seo_keywords & """ />"
        'Literal3.Text = "<meta name=""description"" content=""" & seo_sp & seo_dp & "国际空运" & seo_l & "价格专栏专业发布" & seo_sp & seo_dp & "各大空运" & seo_l & "代理商的最新空运费用报价,如果您有" & seo_sp & seo_dp & "国际空运" & seo_l & "货物需求,请登陆环球运费网" & """ />"
        'SEO部分，结束
    ...
    Sub LoadRecord(ByVal page As String)
        ...
        '提取起运港的中英文名称
        Dim dsfrom As New Data.DataSet
        ...
        If dp = "" And cr = "" Then
            '没有船公司及目的港时
            sql = "select top 15 "
            sql = sql & "sid,id,startport,entitle,line,hits,destport,price_p45,price_p100,price_p300,price_p500,price_p1000,assurance,"
            sql = sql & "userid,"
            ...
            sql = sql & "enddate "
            sql = sql & "FROM (SELECT "
            sql = sql & "distinct t_airinfo.id as sid,'0' as id,t_airinfo.startport as startport,t_airinfo.entitle,t_airinfo.line,t_airinfo.hits,t_airinfo.DestPort1 as destport,t_airinfo.assurance as assurance, "
            ...
            sql = sql & "WHERE "
            sql = sql & "t_airinfo.ifEn=1 AND tb_user.userid = t_airinfo.userid "
        ...
        Else
            ...
            sql = sql & "enddate "
            sql = sql & "FROM (SELECT "
            sql = sql & "t_airinfo.id as sid,t_airprice.id as id,t_airinfo.startport as startport,t_airinfo.entitle,t_airinfo.line,t_airinfo.hits,t_airprice.DestPort as destport,t_airprice.assurance as assurance,"
            ...
            sql = sql & "WHERE "
            sql = sql & "t_airinfo.ifEn=1 AND t_airinfo.id = t_airprice.airid AND tb_user.userid = t_airinfo.userid "
        ...
        Else
            ...
            sql = sql & "WHERE "
            sql = sql & "t_airinfo.ifEn=1 AND t_airinfo.id = t_airprice.airid "
        ...
        Dim base_url As String = "/en/air/list-" & sp & "-" & dp & "-" & cr & "-" & l & "-" & order & "-0-----"
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        If txtDestport.Text <> "" Then
            Response.Redirect("/en/air/list-" & txtStartport.Text & "-" & txtDestport.Text.ToLower & "--0-0-0-----1.html")
        Else
            Response.Redirect("/en/air/list-" & txtStartport.Text & "-" & txtDestport.Text.ToLower & "--" & txtLine.SelectedIndex.ToString & "-0-0-----1.html")
        End If
    End Sub
        ...
        If IsNumeric(txtPageJump.Value) Then
            ...
            Else
                If CInt(txtPageJump.Value.ToString) > CInt(hidTotalPage.Value) Then
                    Response.Redirect("/en/air/list-" & txtStartport.Text & "-" & txtDestport.Text.ToLower & "--" & txtLine.SelectedIndex.ToString & "-0-0-----" & lblTotalPage.Text & ".html")
                Else
                    Response.Redirect("/en/air/list-" & txtStartport.Text & "-" & txtDestport.Text.ToLower & "--" & txtLine.SelectedIndex.ToString & "-0-0-----" & txtPageJump.Value & ".html")
                End If
            End If
        End If

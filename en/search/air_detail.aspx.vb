...
Partial Class en_search_fcl_detail
    ...
    Sub LoadDetail()
        ...
        If ds.Tables("city").Rows.Count > 0 Then
            sqlstarport = "and (t_airinfo.startport like '%" & ds.Tables("city").Rows(0)(0).ToString & "%' "
            sqlstarport = sqlstarport + "or t_airinfo.startport like '%" & ds.Tables("city").Rows(0)(1).ToString & "%' "
            sqlstarport = sqlstarport + "or t_airinfo.startport like '%" & ds.Tables("city").Rows(0)(2).ToString & "%') "
            city0 = ds.Tables("city").Rows(0)(0).ToString
        Else
            sqlstarport = "and t_airinfo.startport like '%" & Literal5.Text & "%' "
            city0 = Literal5.Text
        End If
        ...
        If ds.Tables("city").Rows.Count > 0 Then
            sqldestport = "and (t_airprice.destport like '%" & ds.Tables("city").Rows(0)(0).ToString & "%' "
            sqldestport = sqldestport + "or t_airprice.destport like '%" & ds.Tables("city").Rows(0)(1).ToString & "%' "
            sqldestport = sqldestport + "or t_airprice.destport like '%" & ds.Tables("city").Rows(0)(2).ToString & "%') "
            city1 = ds.Tables("city").Rows(0)(0).ToString
        Else
            sqldestport = "and t_airprice.destport like '%" & LabDestport.Text & "%' "
            city1 = LabDestport.Text
        End If
        ...
        If did <> "0" Then
            ...
            If ds.Tables("search").Rows.Count > 0 Then
                ...
                LitM.Text = ds.Tables("search").Rows(0)("PRICE_M").ToString
                LitN.Text = ds.Tables("search").Rows(0)("PRICE_N").ToString
                Lit45.Text = ds.Tables("search").Rows(0)("PRICE_P45").ToString
                Lit100.Text = ds.Tables("search").Rows(0)("PRICE_P100").ToString
                Lit300.Text = ds.Tables("search").Rows(0)("PRICE_P300").ToString
                Lit500.Text = ds.Tables("search").Rows(0)("PRICE_P500").ToString
                Lit1000.Text = ds.Tables("search").Rows(0)("PRICE_P1000").ToString
        ...
        Else
            ...
            Else
                sqldetail = sqldetail & "AND AIRID = " & id & " "
            End If
            sqldetail = sqldetail & "ORDER BY T_AIRPRICE.AIRID DESC"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fcl.aspx.vb" Inherits="en_search_fcl" %>
...
<li class="divider"></li>
<li class="st"><a href="/en/fcl/">FCL Freight</a></li>
<li class="divider"></li>
...
<td width="50"><strong>20GP</strong></td>
<td width="50"><strong>40GP</strong></td>
<td width="50"><strong>40HQ</strong></td>
...
<td width="50" align="left" class="blue"><a href="/en/fcl/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#GetFirstString(Eval("price20gp").ToString, 4)%></a></td>
<td width="50" align="left" class="blue"><a href="/en/fcl/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#GetFirstString(Eval("price40gp").ToString, 4)%></a></td>
<td width="50" align="left" class="blue"><a href="/en/fcl/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#GetFirstString(Eval("price40hq").ToString, 4)%></a></td>

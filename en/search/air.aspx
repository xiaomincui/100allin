<%@ Page Language="VB" AutoEventWireup="false" CodeFile="air.aspx.vb" Inherits="en_search_lcl" %>
...
<li class="divider"></li>
<li class="st"><a href="/en/air/">Air Freight</a></li>
<li class="divider"></li>
...
<td width="50"><strong>45</strong></td>
<td width="50"><strong>100</strong></td>
<td width="50"><strong>300</strong></td>
<td width="50"><strong>500</strong></td>
<td width="50"><strong>1000</strong></td>
...
<tr>
<td width="10" height="42">&nbsp;</td>
<td width="65" align="left"><%#GetFirstString(LineCNtoEN(Eval("LINE").ToString), 4)%></td>
...
<td width="50" align="left" class="blue"><a href="/en/air/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#GetFirstString(Eval("PRICE_P45").ToString, 4)%></a></td>
<td width="50" align="left" class="blue"><a href="/en/air/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#GetFirstString(Eval("PRICE_P100").ToString, 4)%></a></td>
<td width="50" align="left" class="blue"><a href="/en/air/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#GetFirstString(Eval("PRICE_P300").ToString, 4)%></a></td>
<td width="50" align="left" class="blue"><a href="/en/air/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#GetFirstString(Eval("PRICE_P500").ToString, 4)%></a></td>
<td width="50" align="left" class="blue"><a href="/en/air/<%# key(eval("sid")) %>_<%# eval("id") %>.html" target="_blank"><%#GetFirstString(Eval("PRICE_P1000").ToString, 4)%></a></td>

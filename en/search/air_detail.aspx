<%@ Page Language="VB" AutoEventWireup="false" CodeFile="air_detail.aspx.vb" Inherits="en_search_fcl_detail" %>
...
<asp:Literal id="Literal1" runat="server"><title>AIR-100allin</title></asp:Literal>
...
<li><a href="/en/company/">Company</a></li>
			...
			<div class="menu">
				<h1><a href="../">Home</a> > <a href="../fcl/">AIR</a> > <asp:Literal ID="Label1" runat="server" Text="运价标题"></asp:Literal></h1>
			</div>
		<div class="main_page">
			<div class="info_box">
						<div class="info_left">
					<ul>
						<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Rate Type</strong> : <span class="blue">AIR</span></li>
						...
						<table>
						<tr>
						<td style="width:70px" class="sju">M</td>
						<td style="width:70px" class="sju">N</td>
						<td style="width:70px" class="sju">+45</td>
						<td style="width:70px" class="sju">+100</td>
						<td style="width:70px" class="sju">+300</td>
						<td style="width:70px" class="sju">+500</td>
						<td style="width:70px" class="sju">+1000</td>
						</tr>
						<tr>
						<td><asp:Literal ID="LitM" runat="server"></asp:Literal></td>
						<td><asp:Literal ID="LitN" runat="server"></asp:Literal></td>
						<td><asp:Literal ID="Lit45" runat="server"></asp:Literal></td>
						<td><asp:Literal ID="Lit100" runat="server"></asp:Literal></td>
						<td><asp:Literal ID="Lit300" runat="server"></asp:Literal></td>
						<td><asp:Literal ID="Lit500" runat="server"></asp:Literal></td>
						<td><asp:Literal ID="Lit1000" runat="server"></asp:Literal></td>
						</tr>
						</table>
						<%--<span class="sju">20GP:<a class="blue"><asp:Literal ID="Lab20GP" runat="server"></asp:Literal></a></span>
						<span class="sju">40GP:<a class="blue"><asp:Literal ID="Lab40GP" runat="server"></asp:Literal></a></span>
						<span class="sju">40HQ:<a class="blue"><asp:Literal ID="Lab40HQ" runat="server"></asp:Literal></a></span>
						<span class="sju">45HQ:<a class="blue"><asp:Literal ID="Lab45HQ" runat="server"></asp:Literal></a></span>--%>
						</div>
					  </li>
			...
			<div class="fcl_rd">
				...
				<div class="fcl_rd_bg"><table id="pd" width="874" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEFAEE">
								<tr>
								  ...
								  <td width="65" align="left" bgcolor="#E9F3F8" class="blue_1"><strong>M</strong></td>
								  <td width="65" align="left" bgcolor="#E9F3F8" class="blue_1"><strong>N</strong></td>
								  <td width="65" align="left" bgcolor="#E9F3F8" class="blue_1"><strong>+45</strong></td>
								  <td width="65" align="left" bgcolor="#E9F3F8" class="blue_1"><strong>+100</strong></td>
								  <td width="65" align="left" bgcolor="#E9F3F8" class="blue_1"><strong>+300</strong></td>
								  <td width="65" align="left" bgcolor="#E9F3F8" class="blue_1"><strong>+500</strong></td>
								  <td width="65" align="left" bgcolor="#E9F3F8" class="blue_1"><strong>+1000</strong></td>
                                ...
                                <tr>
                                  ...
                                  <td align="left" bgcolor="#FFFFFF" class="blue"><%#Eval("PRICE_M")%></td>
                                  <td align="left" bgcolor="#FFFFFF" class="blue"><%#Eval("PRICE_N")%></td>
                                  <td align="left" bgcolor="#FFFFFF" class="blue"><%#Eval("PRICE_P45")%></td>
                                  <td align="left" bgcolor="#FFFFFF" class="blue"><%#Eval("PRICE_P100")%></td>
                                  <td align="left" bgcolor="#FFFFFF" class="blue"><%#Eval("PRICE_P300")%></td>
                                  <td align="left" bgcolor="#FFFFFF" class="blue"><%#Eval("PRICE_P500")%></td>
                                  <td align="left" bgcolor="#FFFFFF" class="blue"><%#Eval("PRICE_P1000")%></td>
                                  ...
                                  <td align="center" bgcolor="#FFFFFF"><%#Eval("memo")%></td>
                                </tr>
                                </ItemTemplate>
                                </asp:Repeater>								
							  </table>

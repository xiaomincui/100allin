...
public partial class en_sign : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            if (Request.ServerVariables["HTTP_REFERER"] != null)
            {
                ...
                {
                    Response.Redirect("sign.aspx?redirect_url=" + Server.UrlEncode(Request.ServerVariables["HTTP_REFERER"].ToString()));

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="office_air_list.aspx.vb" Inherits="en_member_office_fcl_list" %>
...
<div class="bill_box" style="line-height:18px; background:#FFFBCA; border:1px dashed #FFCC00; margin-top:8px; font-size:12px">
	  ...
	  <tr>
		...
		<td width="20%" height="32" align="center"><strong>Title</strong></td>
		<td width="9%" height="32" align="center"><strong>line</strong></td>
      ...
      <td bgcolor="<%# IIF((Container.ItemIndex mod 2)=1 , "#f0f0f0" , "") %>"><input id="id" type="checkbox" value="<%# eval("id") %>" onclick="checkToList(this.form)" /></td>
		...
		<td bgcolor="<%# IIF((Container.ItemIndex mod 2)=1 , "#f0f0f0" , "") %>"><%#LineCNtoEN(Eval("Line"))%></td>
		...
		<td bgcolor="<%# IIF((Container.ItemIndex mod 2)=1 , "#f0f0f0" , "") %>"><div class="edit"><a href="office_air_edit.aspx?id=<%# eval("id") %>">Edit</a>&nbsp;&nbsp;<a href="javascript:delConfirm('<%# eval("id") %>')">Del</a></div></td>
	  </tr>
	  </ItemTemplate>
      </asp:Repeater>

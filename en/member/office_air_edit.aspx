<%@ Page Language="C#" AutoEventWireup="true" CodeFile="office_air_edit.aspx.cs" Inherits="en_office_sent" %>
...
<body>
    ...
    <enusertop:enusertop ID="enusertop1" runat="server" />
	  ...
	  <tr>
	    <td height="28" align="right">Post date&nbsp;:</td>
	    <td>
...
//]]>
	  ...
	  <tr>
	    ...
	    <asp:DropDownList ID="DropDownList1" runat="server">
            ...
            <asp:ListItem Value="北美线">North America</asp:ListItem>
            <asp:ListItem Value="南美线">South America</asp:ListItem>
            <asp:ListItem Value="欧洲线">Euro</asp:ListItem>
            <asp:ListItem Value="亚洲线">Asia</asp:ListItem>
            <asp:ListItem Value="国内航线">China</asp:ListItem>
        </asp:DropDownList>
	  ...
	  <tr>
	    ...
	    <td>&nbsp;</td>
			        ...
			        <table width="100%" border="0" cellpadding="0" cellspacing="3" bgcolor="#E8F6FF" id="GridView2">
                      <tr>
                        <td height="28" colspan="13" align="left" bgcolor="#BBDBEA">&nbsp;&nbsp;&nbsp;&nbsp;从EXCEL中复制内容，粘粘在下列行中，快捷方便，赶紧试试！看清格式，别粘错了哦！</td>
                      </tr>
					  <tr>
                        ...
                        <td align="center"><input name="textfield4355" type="text" class="ms_text" size="4" value="<%# Eval("PRICE_M") %>" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"  /></td>
                        <td align="center"><input name="textfield43552" type="text" class="ms_text" size="4" value="<%# Eval("PRICE_N") %>" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"  /></td>
                        <td align="center"><input name="textfield43553" type="text" class="ms_text" size="4" value="<%# Eval("PRICE_P45") %>" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"  /></td>
                        <td align="center"><input name="textfield43554" type="text" class="ms_text" size="4" value="<%# Eval("PRICE_P100") %>" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"  /></td>
                        <td align="center"><input name="textfield43552" type="text" class="ms_text" size="4" value="<%# Eval("PRICE_P300") %>" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"  /></td>
                        <td align="center"><input name="textfield43553" type="text" class="ms_text" size="4" value="<%# Eval("PRICE_P500") %>" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"  /></td>
                        <td align="center"><input name="textfield43554" type="text" class="ms_text" size="4" value="<%# Eval("PRICE_P1000") %>" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"  /></td>

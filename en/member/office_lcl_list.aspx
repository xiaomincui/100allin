<%@ Page Language="VB" AutoEventWireup="false" CodeFile="office_lcl_list.aspx.vb" Inherits="en_member_office_fcl_list" %>
...
<asp:ListItem Value="红海线">Red Sea</asp:ListItem>
      ...
      <td bgcolor="<%# IIF((Container.ItemIndex mod 2)=1 , "#f0f0f0" , "") %>"><input id="id" type="checkbox" value="<%# eval("id") %>" onclick="checkToList(this.form)" /></td>
		...
		<td bgcolor="<%# IIF((Container.ItemIndex mod 2)=1 , "#f0f0f0" , "") %>"><div class="edit"><a href="office_lcl_edit.aspx?id=<%# eval("id") %>">Edit</a>&nbsp;&nbsp;<a href="javascript:delConfirm('<%# eval("id") %>')">Del</a></div></td>
	  </tr>
	  </ItemTemplate>
      </asp:Repeater>

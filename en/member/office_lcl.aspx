<%@ Page Language="C#" AutoEventWireup="true" CodeFile="office_lcl.aspx.cs" Inherits="en_office_sent" %>
...
<body>
    ...
    <enusertop:enusertop ID="enusertop1" runat="server" />
		...
		<div class="main_page">
			...
			<div class="of_rg">
				<div class="of_rg_bar">
					<div class="of_rg_solo">Hello, nature</div>
	    ...
	    <td>&nbsp;</td>
			        ...
			        <table width="100%" border="0" cellpadding="0" cellspacing="3" bgcolor="#E8F6FF" id="GridView2">
					  ...
					  <tr>
                        ...
                        <td align="center"><input name="textfield4355" type="text" class="ms_text" size="4" value="<%# Eval("pricegp") %>" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"  /></td>
                        <td align="center"><input name="textfield43552" type="text" class="ms_text" size="4" value="<%# Eval("pricegpv") %>" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"  /></td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addfriend.aspx.cs" Inherits="member_addfriend" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                  ...
                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                      <td height="52" colspan="2">
                          <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="/member/images/ms_bt6.gif" OnClick="ImageButton2_Click" />
                          <asp:Label ID="Label2" runat="server" Text="您已经是TA好友" ForeColor="Gray" Visible="false"></asp:Label>
                      <%--<a href="#"><img src="/member/images/ms_bt6.gif" border="0" /></a>--%></td>
                    </tr>
                  </table>
		        </div>
		      </div>

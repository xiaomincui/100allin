<%@ Page Language="VB" AutoEventWireup="false" CodeFile="releaseselect.aspx.vb" Inherits="member_releaseselect" %>
...
<td width="44%"><strong>请选择您要发布的运价类型</strong></td>
          ...
          <tr>
            ...
            <td colspan="2" align="left"><table class="other_yf" width="100%" border="0" cellpadding="0" cellspacing="1">
                <tr>
                  ...
                  <a href="/member/release.aspx">整箱运价</a><a href="/member/spellrelease.aspx">拼箱运价</a><a href="/member/airrelease.aspx">空运运价</a>
                  </td>
                  </tr>

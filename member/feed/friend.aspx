<%@ Page Language="C#" AutoEventWireup="true" CodeFile="friend.aspx.cs" Inherits="member_feed_friend" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <memberheader:memberheader ID="memberheader1" runat="server" />
		<div class="center">
	        ...
	        <div class="center_box">
				<div class="dynamic">
					<div class="dynamic_title"><strong>商友动态</strong></div>
					<DIV id=tabs1>
					  <DIV class=menu1box>
								<UL id=menu1>
...
<%#Convert.ToDateTime(Eval("POSTDATE").ToString()).ToString("h:mm:ss").ToString() %></td>

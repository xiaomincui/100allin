<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AirRelease_old.aspx.vb" Inherits="member_SpellRelease"  EnableEventValidation="false"%>
...
<body>
  ...
  <tr>
    ...
    <td width="50%" align="right"><a href="AirRelease_1.aspx">切换到新版</a></td>
  </tr>
</table>
</div>
				<div class="fcl">
			 ...
			 <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"  Width="100%" Height="1px" border="0" cellspacing="3" cellpadding="0" >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="目的港">
                        ...
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("DestPort") %>' Width="72px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="M" SortExpression="PRICE_M">
                        ...
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("PRICE_M") %>' Width="47px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="N" SortExpression="PRICE_N">
                        ...
                        <ItemStyle Width="53px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("PRICE_N") %>' Width="47px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="45" SortExpression="PRICE_P45">
                        ...
                        <ItemStyle Width="53px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("PRICE_P45") %>' Width="47px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="100" SortExpression="PRICE_P100">
                        ...
                        <ItemStyle Width="53px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("PRICE_P100") %>' Width="47px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="300" SortExpression="PRICE_P300">
                        ...
                        <ItemStyle Width="53px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("PRICE_P300") %>' Width="47px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="500" SortExpression="PRICE_P500">
                        ...
                        <ItemStyle Width="53px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("PRICE_P500") %>' Width="47px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="1000" SortExpression="PRICE_P1000">
                        ...
                        <ItemStyle Width="53px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox8" runat="server" Text='<%# Bind("PRICE_P1000") %>' Width="47px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="附加费">
                        ...
                        <ItemStyle Width="53px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("price20gpAppend") %>' CssClass="ms_text" Width="47px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="航程">
                        ...
                        <ItemStyle Width="53px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox10" runat="server" Text='<%# Bind("Distance") %>' CssClass="ms_text" Width="47px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="出发日">
                        ...
                        <ItemStyle Width="53px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox11" runat="server" Text='<%# Bind("DepartureWkd") %>' CssClass="ms_text" Width="47px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="备注">
                        ...
                        <ItemStyle Width="53px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox12" runat="server" Text='<%# Bind("memo") %>' CssClass="ms_text" Width="47px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>

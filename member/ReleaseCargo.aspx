<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReleaseCargo.aspx.cs" Inherits="member_temp_add_air" ValidateRequest="false" %>
...
<body>
    ...
    <div class="main_container">
		...
		<div class="center">
		  ...
		  <div class="friend_title" style="margin:0px 0px 10px 0px"><strong>发布紧急询价</strong></div>	   
		  
		  <div class="bill_box" style="line-height:7px; background:#FFFBCA; border:1px dashed #FFCC00;margin:0px 0px 5px 0px">
				
			    <p style="margin:0px 7px;">			    &nbsp;<img src="images/light.gif" />			    友情提示：为了您能获得快速准确的报价，询价时请准确填写运输方式、起运港、目的港、货物品名、货量、出货时间等信息。<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;并留下您的联系方式。</p>
		    </div>
...
<div class="mainbox formbox" style="width:800px;float:left">

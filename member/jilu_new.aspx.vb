...
Partial Class member_jilu
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            For i As Integer = 0 To dsyunjia.Tables("yunjia").Rows.Count - 1
                strTemp += dsyunjia.Tables("yunjia").Rows(i)("DestPort").ToString() + ""
                strTemp += dsyunjia.Tables("yunjia").Rows(i)("price20gp").ToString() + ""
                strTemp += dsyunjia.Tables("yunjia").Rows(i)("price40gp").ToString() + ""
                strTemp += dsyunjia.Tables("yunjia").Rows(i)("price40hq").ToString() + ""
                strTemp += dsyunjia.Tables("yunjia").Rows(i)("price45hq").ToString() + ""
                strTemp += dsyunjia.Tables("yunjia").Rows(i)("price20gpAppend").ToString() + ""
                strTemp += dsyunjia.Tables("yunjia").Rows(i)("Distance").ToString() + ""
                strTemp += dsyunjia.Tables("yunjia").Rows(i)("DepartureWkd").ToString() + ""
                strTemp += dsyunjia.Tables("yunjia").Rows(i)("shipcompany").ToString() + ""
                If CInt(ds2.Tables("table").Rows(0)("star_allin")) = 1 Then
                    strTemp += dsyunjia.Tables("yunjia").Rows(i)("memo").ToString() + ""
                    strTemp += dsyunjia.Tables("yunjia").Rows(i)("assurance").ToString() + ""
                Else
                    strTemp += dsyunjia.Tables("yunjia").Rows(i)("memo").ToString() + ""
                End If
    ...
    Protected Sub Button11_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button11.Click
        ...
        For k = 0 To strsubmitrow.Length - 2
            If strsubmitrow(k).Substring(0, 8) = "" Then

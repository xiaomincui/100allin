<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Release_2.aspx.vb" Inherits="member_Release_1"  EnableEventValidation="false"%>
...
<body>
  ...
  <tr>
    ...
    <td width="50%" align="right">
        <asp:CheckBox ID="chken" runat="server" /><asp:Label ID="Label1" runat="server" Text="同时发布英文版运价"></asp:Label>
    <%--<a href="/topic/order20091104/product_1.aspx" target="_blank"><img src="images/ttt_3.gif" width="152" height="27" border="0" /></a>--%></td>
  </tr>
</table>
</div>
				<div class="fcl">

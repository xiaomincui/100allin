<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lcllist.aspx.vb" Inherits="lcllist" EnableEventValidation="false" %>
...
<body>
  ...
  <tr>
    ...
    <td width="50%" align="right"><a href="/member/SpellRelease.aspx"><img src="images/ttt2_p.gif" border="0" /></a></td>
  </tr>
</table>
</div>
          ...
          <td width="570px"><div style="text-align:right;">您搜索的是：&nbsp;<strong><asp:Label ID="hidTxtYunjiaid" runat="server">
			...
			<div class="fcl" style="padding:0px;">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <td align="center" bgcolor="#FFFFFF"><div class="titleText"><nobr><a href="/lcl/<%# key(eval("id")) %>_0.html" target="_blank"><strong><asp:Label ID="Label3" runat="server" Text='<%# eval("title") %>'></asp:Label></strong></a></nobr></div></td>
                  ...
                  <td align="center" bgcolor="#FFFFFF"><div class="edit"><a href="Spelljilu.aspx?id=<%# eval("id") %>">编辑</a>&nbsp;&nbsp;<a href="javascript:delConfirm('<%# eval("id") %>')">删除</a></div></td>
                </tr>
                  </ItemTemplate>
                  </asp:Repeater>

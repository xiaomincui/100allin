<%@ Page Language="VB" AutoEventWireup="false" CodeFile="airlist.aspx.vb" Inherits="member_airlist" EnableEventValidation="false"%>
...
<body>
  ...
  <tr>
    ...
    <td width="50%" align="right"><a href="/member/AirRelease.aspx"><img src="images/ttt2_k.gif" border="0" /></a></td>
  </tr>
</table>
</div>
<div style="color:red;">公告：亲爱的用户，空运运价数据整理优化已完成，部分用户反映的之前发布的部分空运运价无法正常显示的问题已解决，给您造成不便敬请谅解</div>
          ...
          <td width="570px"><div style="text-align:right;">您搜索的是：&nbsp;<strong><asp:Label ID="hidTxtYunjiaid" runat="server">
			...
			<div class="fcl" style="padding:0px;">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <td align="center" bgcolor="#FFFFFF"><div class="titleText"><nobr><a href="/air/<%# key(eval("id")) %>_0.html" target="_blank"><strong><asp:Label ID="Label3" runat="server" Text='<%# eval("title") %>'></asp:Label></strong></a></nobr></div></td>
                  <td align="center" bgcolor="#FFFFFF"><div class="dateText"><asp:Label ID="Label4" runat="server" Text='<%# eval("line") %>'></asp:Label></div></td>
                  ...
                  <td align="center" bgcolor="#FFFFFF"><div class="edit"><a href="airjilu.aspx?id=<%# eval("id") %>">编辑</a>&nbsp;&nbsp;<a href="javascript:delConfirm('<%# eval("id") %>')">删除</a></div></td>
                </tr>
                  </ItemTemplate>
                  </asp:Repeater>

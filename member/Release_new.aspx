<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Release_new.aspx.vb" Inherits="member_Release_1"  EnableEventValidation="false"%>
...
//]]>
		...
		<input id="trdsum" style="width: 30px" type="text" value="5" /><input id="deltr" type="button" value="删除" />

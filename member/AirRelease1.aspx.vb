...
Partial Class member_Release
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For k = 0 To strsubmitrow.Length - 2
            If strsubmitrow(k).Substring(0, 1) = "qwerhjkl" And strsubmitrow(k) <> "qwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjkl" Then
        ...
        Else
            ...
            For i = 0 To strarray.Length - 2
                If strarray(i) <> "qwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjklqwerhjkl" Then
            ...
            strSQL += "update T_AIRINFO set DestPort1='" + check.CheckInput(strrow(0)) + "',PRICE_P451='" + check.CheckInput(strrow(3)) + "',PRICE_P1001='" + check.CheckInput(strrow(4)) + "',PRICE_P3001='" + check.CheckInput(strrow(5)) + "',PRICE_P5001='" + check.CheckInput(strrow(6)) + "',PRICE_P10001='" + check.CheckInput(strrow(7)) + "' where id=" + id.ToString + ";"

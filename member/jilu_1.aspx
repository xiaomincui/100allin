<%@ Page Language="VB" AutoEventWireup="false" CodeFile="jilu_1.aspx.vb" Inherits="member_jilu" %>
...
//    }  
  ...
  {   
      for(var k=0;k<num;k++)
      {
          ...
          newcell.innerHTML=   " <input  type='text' class='ms_text'  style='width:57px;' onpaste ='insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)'  onKeyDown='insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)' />"
          newcell.width="63px"
          var   i=8;   
          while(i--)
          {   
...
function endisplay()
{
    if(document.getElementById("chken").checked)
    {
        document.getElementById("entitle").style.display = "";
        document.getElementById("enmeno").style.display = "";
    }
    else
    {
        document.getElementById("entitle").style.display = "none";
        document.getElementById("enmeno").style.display = "none";
    }
}
	</script>
    <style type="text/css">
...
<body>
  ...
  <tr>
    ...
    <asp:CheckBox ID="chken" runat="server" /><asp:Label ID="Label1" runat="server"
        Text="同时发布英文版运价"></asp:Label>
    <%--<a href="#"><img src="images/ttt.gif" width="152" height="27" border="0" /></a>--%></td>
  </tr>
</table>
</div>
				<div class="fcl">
					  ...
					  <table width="100%" border="0" cellspacing="1" cellpadding="0" style="font-size:14px">
                        ...
                        <tr  id="entitle" style="display:none" runat="server">
                          <td width="3%" height="28">&nbsp;</td>
                          <td width="15%"><span class="red">*</span> title：</td>
                          <td align="left"><asp:TextBox ID="TextBox2" CssClass="ms_text" runat="server" Width="240px"></asp:TextBox></td>
                        </tr>
                        <tr>
                          <td height="28">&nbsp;</td>
                          <td>&nbsp;&nbsp;发布时间：</td>
...
//]]>
            ...
            <asp:ListItem>红海线</asp:ListItem>
                        ...
                        <tr  id="enmeno" style="display:none" runat="server">
                          <td height="65">&nbsp;</td>
                          <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Meno：</td>
                          <td align="left"><asp:TextBox ID="TextBox3" CssClass="ms_text" runat="server" Height="63px" Width="500px" TextMode="MultiLine" ></asp:TextBox></td>
                        </tr>
                      </table>
  ...
  <tr>
    ...
    <td><asp:TextBox ID="txtPostNumber" runat="server" BackColor="#F2F8FB" BorderWidth="0px"
			 ...
			 <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"  Width="100%" Height="1px" border="0" cellspacing="3" cellpadding="0" >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="目的港">
                        ...
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# HttpContext.Current.Server.HtmlDecode(Eval("DestPort").ToString) %>' Width="60px" CssClass="ms_text" onkeyup="autowords(this.id,event,2);" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="20GP">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox12" runat="server" Text='<%# Bind("price20gp") %>' Width="64px"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="66px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox12" runat="server" Text='<%# HttpContext.Current.Server.HtmlDecode(Eval("price20gp").ToString) %>' Width="60px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="40GP">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox22" runat="server" Text='<%# Bind("price40gp") %>' Width="64px"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="66px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox22" runat="server" Text='<%# HttpContext.Current.Server.HtmlDecode(Eval("price40gp").ToString) %>' Width="60px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="40HQ">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox32" runat="server" Text='<%# Bind("price40hq") %>' Width="64px"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="66px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox32" runat="server" Text='<%# HttpContext.Current.Server.HtmlDecode(Eval("price40hq").ToString) %>' Width="60px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="45HQ">
                        ...
                        <ItemStyle Width="66px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox33" runat="server" Text='<%# HttpContext.Current.Server.HtmlDecode(Eval("price45hq").ToString) %>' Width="60px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="附加费">
                        ...
                        <ItemStyle Width="66px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox6" runat="server" Text='<%# HttpContext.Current.Server.HtmlDecode(Eval("price20gpAppend").ToString) %>' CssClass="ms_text" Width="60px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="航程">
                        ...
                        <ItemStyle Width="66px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox7" runat="server" Text='<%# HttpContext.Current.Server.HtmlDecode(Eval("Distance").ToString) %>' CssClass="ms_text" Width="60px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="出发日">
                        ...
                        <ItemStyle Width="66px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox8" runat="server" Text='<%# HttpContext.Current.Server.HtmlDecode(Eval("DepartureWkd").ToString) %>' CssClass="ms_text" Width="60px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="船公司">
                        ...
                        <ItemStyle Width="66px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox18" runat="server" Text='<%# HttpContext.Current.Server.HtmlDecode(Eval("shipcompany").ToString) %>' CssClass="ms_text" Width="60px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onkeyup="autowords(this.id,event,3);" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="备注">
                        ...
                        <ItemStyle Width="66px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox9" runat="server" Text='<%# HttpContext.Current.Server.HtmlDecode(Eval("memo").ToString) %>' CssClass="ms_text" Width="60px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
        ...
        <input id="Button5" type="button" value="添加1行" language="javascript" onclick="addRow(document.getElementById('GridView2'),1)" /></td>
        <td style="height: 25px; width: 64px;">
        <input id="Button2" type="button" value="添加5行" language="javascript" onclick="addRow(document.getElementById('GridView2'),5)" /></td>
        <td style="height: 25px; width: 64px;">
        <input id="Button3" type="button" value="添加10行" language="javascript" onclick="addRow(document.getElementById('GridView2'),10)" /></td>
        <td style="height: 25px; width: 64px;">
        <input id="Button4" type="button" value="添加50行" language="javascript" onclick="addRow(document.getElementById('GridView2'),50)" /></td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new.aspx.cs" Inherits="pro_order_new" EnableEventValidation="false" EnableViewState="false" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                                ...
                                <tbody>
                                    <tr>
                                        <th width="50%" rowspan="8">
                                            ...
                                            <textarea class="pr10 pl10" id="txtShipperName" rows="7" cols="60" title="提示|请在这里填写发货人名称，注意名称请写全，此项必填" runat="server"></textarea>
                                            <div class="hr">
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <th align="middle" width="42%">
                                            <center>
                                                ...
                                                <textarea name="description" rows="15" cols="45" id="txtCargoName" runat="server"></textarea>
                                            </center>
                                        </th>
                                        ...
                                        <th align="middle" width="12%">
                                            <center>
                                                ...
                                                <textarea name="measurement" rows="15" cols="16" id="txtMeasurement" runat="server"></textarea></center>
                                        </th>
                                    </tr>
                                </tbody>
                            </table>
                            <table id="order_table_a" style="border-top-width: 0px" cellspacing="0" cellpadding="0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="3">
                                            20GP：
                                            <input size="2" name="packages" id="txtContainer_20gp" runat="server">
                                            个&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 40GP：
                                            <input size="2" name="packages" id="txtContainer_40gp" runat="server">
                                            个&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 40HQ：
                                            <input size="2" name="packages" id="txtContainer_40hq" runat="server">
                                            个&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </th>
                                        <th>

			 ...
			 <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"  Width="100%" Height="1px" border="0" cellspacing="3" cellpadding="0" >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="*船公司">
                        ...
                        <ItemStyle Width="66px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox18" runat="server" Text='<%# eval("shipcompany") %>' onkeyup="autowords(this.id,event,3);" CssClass="ms_text" Width="60px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>

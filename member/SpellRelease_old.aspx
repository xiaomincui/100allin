<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SpellRelease_old.aspx.vb" Inherits="member_SpellRelease1"  EnableEventValidation="false"%>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>环球运费网 - 我的办公室 - 拼箱运价</title>
...
<body>
  ...
  <tr>
    ...
    <td width="44%"><strong>发布拼箱运价</strong></td>
			 ...
			 <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"  Width="100%" Height="1px" border="0" cellspacing="3" cellpadding="0" >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="目的港">
                        ...
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("DestPort") %>' onkeyup="autowords(this.id,event,2);" Width="78px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="价格(体积)">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox29" runat="server" Text='<%# Bind("pricegpv") %>' Width="64px"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="84px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox29" runat="server" Text='<%# Bind("pricegpv") %>' Width="78px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="价格(重量)">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("pricegp") %>' Width="64px"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="84px" />
                        <ItemTemplate>
                             <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("pricegp") %>' Width="78px" CssClass="ms_text" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="附加费">
                        ...
                        <ItemStyle Width="84px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("price20gpAppend") %>' CssClass="ms_text" Width="78px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="航程">
                        ...
                        <ItemStyle Width="84px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("Distance") %>' CssClass="ms_text" Width="78px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="出发日">
                        ...
                        <ItemStyle Width="84px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox8" runat="server" Text='<%# Bind("DepartureWkd") %>' CssClass="ms_text" Width="78px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="船公司">
                        ...
                        <ItemStyle Width="84px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox18" runat="server" Text='<%# Bind("shipcompany") %>' CssClass="ms_text" Width="78px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onkeyup="autowords(this.id,event,3);" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="备注">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("memo") %>' CssClass="ms_text" Width="130px"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="84px" />
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("memo") %>' CssClass="ms_text" Width="78px" onpaste ="insertTableOnpaste(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)" onKeyDown="insertTable(this.parentNode.cellIndex,this.parentNode.parentNode.rowIndex)"></asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="False" />
                    </asp:TemplateField>

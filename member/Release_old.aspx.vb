...
Partial Class member_Release_1
    ...
    Protected Sub Button11_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button11.Click
        ...
        Else
            ...
            Dim dsStartPort As Data.DataSet = cn.mdb_ds("select * from TB_CHINACITY where CityName='" + check.CheckInput(txtStart.Text.Trim().Replace("'", "''")) + "' or CityNameCH='" + check.CheckInput(txtStart.Text.Trim().Replace("'", "''")) + "'", "StartPort")

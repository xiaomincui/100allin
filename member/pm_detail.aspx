<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pm_detail.aspx.cs" Inherits="member_pm_detail" enableEventValidation="false" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <memberheader:memberheader ID="memberheader1" runat="server" />
		<div class="center">
          ...
          <a href="pm.aspx?filter=my">发件箱</a>						
                ...
                <div style="margin:15px 0px 0px 10px; font-size:14px;"><B> <asp:Literal ID="Literal1" runat="server"></asp:Literal>：</B> <span style="font-size:12px;"><asp:Literal ID="Literal2" runat="server"></asp:Literal></span></div>

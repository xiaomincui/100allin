<%@ Page Language="VB" AutoEventWireup="false" CodeFile="jilu_new.aspx.vb" Inherits="member_jilu" %>
...
<body>
  ...
  <tr>
    ...
    <td width="50%" align="right"><%--<a href="#"><img src="images/ttt.gif" width="152" height="27" border="0" /></a>--%></td>
  </tr>
</table>
</div>
				<div class="fcl">
...
//]]>
		...
		<input id="trdsum" style="width: 30px" type="text" value="5" /><input id="deltr" type="button" value="delTR" />
		<input id="dc" type="button" value="删除选中行" />
		<input id="clearall" type="button" value="清空所有" />
		<input id="sub" type="button" value="提交" /><span id="t_message"></span>
		<script type="text/javascript">
            /*
	            動態加載JS文件。
	            加載完成後，才執行 初始化表格動作。

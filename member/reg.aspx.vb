...
Partial Class member_reg
    ...
    Public Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Response.Redirect("/accounts/reg.aspx")
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If ds.Tables("user").Rows.Count <> 0 Then
            ...
            If (Me.FileUpload1.FileName.ToString() <> "") Then
                ...
                filepath = Server.MapPath("Head/") + userid + "(old).jpg"
                FileUpload1.SaveAs(filepath)
                Dim thumbnailimage As New ThumbnailImage
                thumbnailimage.GetThumbnailImage(filepath, Server.MapPath("Head/") + userid + ".jpg", 70, 70)
    ...
    '        connection1 = new MySqlConnection("Database=ucenter;Data Source = localhost;User Id = root;Password = 65127389");

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="temp_add_ship.aspx.cs" Inherits="member_temp_add_air" %>
...
<body>
    ...
    <div class="main_container">
		...
		<div class="center">
		  ...
		  <div class="friend_title"><strong>海运货盘发布管理</strong></div>	   		  
...
//]]>
	...
	<tr align="left"  bgcolor="#F6F6F6" class="news_font">
		...
		<asp:DropDownList ID="type1" runat="server">
          <asp:ListItem Value="整箱">整箱</asp:ListItem>
          <asp:ListItem Value="拼箱">拼箱</asp:ListItem>
          </asp:DropDownList>
          ...
          <asp:ListItem Value="其它">其它航线</asp:ListItem>
                ...
                <tr valign="middle" bgcolor="#F6F6F6" class="news_font"> 
                  <td height="50" colspan="2" align="center" bgcolor="#FFFFFF" class="bgTdMain"><span class="tablebody1">
					...
					&nbsp;&nbsp;
			      <input name="Submit2" type="button" class="InputBtn" value="返回" onclick=history.back() id="Button1" runat="server">
                      <asp:Label ID="labtime" runat="server" Text="Label" Visible="false"></asp:Label>
			      </td>
    </tr>
  </table>

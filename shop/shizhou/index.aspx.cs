...
public partial class shop_bloom_index : System.Web.UI.Page
{
    ...
    public void loadRecord()
    {
        ...
        string[] lblCarrierArray = new string[5];
        lblCarrierArray[0] = "韩进,HANJIN";
        lblCarrierArray[1] = "马士基,MAERSK";
        lblCarrierArray[2] = "地中海,MSC";
        lblCarrierArray[3] = "万海,WANHAI";
        lblCarrierArray[4] = "德翔,TS LINE";
        ...
        for (int i = 0; i < lblCarrierArray.Length ; i++)
        {
        ...
        if (carrier != "")
        {
            sql = sql + "and shipcompany = '" + carrier + "' ";
        }
